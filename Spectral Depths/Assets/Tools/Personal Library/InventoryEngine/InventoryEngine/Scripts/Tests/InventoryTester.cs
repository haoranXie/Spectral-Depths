...
namespace SpectralDepths.InventoryEngine
{
	...
	public class InventoryTester : MonoBehaviour
	{
		...
		/// a test button
		[PLInspectorButton("AddItemAtTest")] 
		...
		/// a test button
		[PLInspectorButton("MoveItemTest")] 
		...
		/// a test button
		[PLInspectorButton("MoveItemToInventory")] 
		...
		/// a test button
		[PLInspectorButton("RemoveItemTest")] 
		...
		/// a test button
		[PLInspectorButton("EmptyInventoryTest")] 
