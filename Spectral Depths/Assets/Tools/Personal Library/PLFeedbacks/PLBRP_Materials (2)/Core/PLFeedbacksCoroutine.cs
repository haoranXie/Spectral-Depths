...
namespace SpectralDepths.Feedbacks
{
	...
	/// Coroutine helpers
	/// </summary>
	public static class PLFeedbacksCoroutine
	{
		/// <summary>
		/// Waits for the specified amount of frames
		/// use : yield return PLCoroutine.WaitFor(1);
		/// </summary>
		...
		/// use : yield return PLCoroutine.WaitFor(1f);
		/// </summary>
		...
		/// use : yield return PLCoroutine.WaitForUnscaled(1f);
		/// </summary>
		/// <param name="seconds"></param>
		/// <returns></returns>
