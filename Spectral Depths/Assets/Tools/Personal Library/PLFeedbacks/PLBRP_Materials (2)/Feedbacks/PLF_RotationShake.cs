...
{
	/// <summary>
	/// This feedback lets you emit a RotationShake event. This will be caught by PLRotationShakers (on the specified channel).
	...
	[FeedbackHelp("This feedback lets you emit a RotationShake event. This will be caught by PLRotationShakers (on the specified channel)." +
	              " Rotation shakers, as the name suggests, are used to shake the rotation of a transform, along a direction, with optional noise and other fine control options.")]
	public class PLF_RotationShake : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Optional Target", true, 33)]
		...
		public PLRotationShaker TargetShaker;
		
		[PLFInspectorGroup("Rotation Shake", true, 28)]
		...
		[PLFInspectorGroup("Shake Settings", true, 42)]
		...
		[PLFInspectorGroup("Direction", true, 43)]
		...
		[PLFCondition("RandomizeDirection", true)]
		...
		[PLFInspectorGroup("Directional Noise", true, 47)]
		...
		[PLFCondition("AddDirectionalNoise", true)]
		...
		[PLFInspectorGroup("Randomness", true, 44)]
		...
		[PLFInspectorGroup("One Time", true, 45)]
		...
		[PLFCondition("UseAttenuation", true)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				PLRotationShakeEvent.Trigger(Duration, ShakeSpeed,  ShakeRange,  ShakeMainDirection,  RandomizeDirection,  ShakeAltDirection,  RandomizeDirectionOnPlay,  AddDirectionalNoise, 
