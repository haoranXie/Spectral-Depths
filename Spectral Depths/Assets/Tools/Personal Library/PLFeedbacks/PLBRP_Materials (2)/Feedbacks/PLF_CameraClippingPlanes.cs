...
{
	/// <summary>
	/// This feedback lets you control a camera's clipping planes over time. You'll need a PLCameraClippingPlanesShaker on your camera.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackPath("Camera/Clipping Planes")]
	[FeedbackHelp("This feedback lets you control a camera's clipping planes over time. You'll need a PLCameraClippingPlanesShaker on your camera.")]
	public class PLF_CameraClippingPlanes : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Clipping Planes", true, 52)]
		...
		[PLFInspectorGroup("Near Plane", true, 53)]
		...
		[PLFInspectorGroup("Far Plane", true, 54)]
		/// the curve used to animate the intensity value on
		[Tooltip("the curve used to animate the intensity value on")]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLCameraClippingPlanesShakeEvent.Trigger(ShakeNear, FeedbackDuration, RemapNearZero, RemapNearOne, 
