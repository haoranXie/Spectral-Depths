...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_CameraZoom : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Camera Zoom", true, 72)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData, 
