...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_Animation : PLF_Feedback 
	{
		...
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return PLFeedbacksInspectorColors.AnimationColor; } }
		...
		[PLFInspectorGroup("Animation", true, 12, true)]
		...
		/// the duration for the player to consider. This won't impact your animation, but is a way to communicate to the PLF Player the duration of this feedback. Usually you'll want it to match your actual animation, and setting it can be useful to have this feedback work with holding pauses.
		[Tooltip("the duration for the player to consider. This won't impact your animation, but is a way to communicate to the PLF Player the duration of this feedback. Usually you'll want it to match your actual animation, and setting it can be useful to have this feedback work with holding pauses.")]
		public float DeclaredDuration = 0f;
        
		[PLFInspectorGroup("Trigger", true, 16)]
		...
		[PLFCondition("UpdateTrigger", true)]
		...
		[PLFInspectorGroup("Random Trigger", true, 20)]
		...
		/// the selected mode to interact with this trigger
		[Tooltip("the selected mode to interact with this trigger")]
		[PLFCondition("UpdateRandomTrigger", true)]
		...
		[PLFInspectorGroup("Bool", true, 17)]
		...
		[PLFInspectorGroup("Random Bool", true, 19)]
		...
		/// the int parameter to turn true when the feedback gets played
		[Tooltip("the int parameter to turn true when the feedback gets played")]
		[PLFEnumCondition("IntValueMode", (int)ValueModes.Constant, (int)ValueModes.Random, (int)ValueModes.Incremental)]
		public string IntParameterName;
		/// the value to set to that int parameter
		[Tooltip("the value to set to that int parameter")]
		[PLFEnumCondition("IntValueMode", (int)ValueModes.Constant)]
		public int IntValue;
		...
		[PLFEnumCondition("IntValueMode", (int)ValueModes.Random)]
		...
		[PLFEnumCondition("IntValueMode", (int)ValueModes.Incremental)]
		public int IntIncrement = 1;

		[PLFInspectorGroup("Float", true, 22)]
		...
		/// the float parameter to turn true when the feedback gets played
		[Tooltip("the float parameter to turn true when the feedback gets played")]
		[PLFEnumCondition("FloatValueMode", (int)ValueModes.Constant, (int)ValueModes.Random, (int)ValueModes.Incremental)]
		public string FloatParameterName;
		/// the value to set to that float parameter
		[Tooltip("the value to set to that float parameter")]
		[PLFEnumCondition("FloatValueMode", (int)ValueModes.Constant)]
		...
		[PLFEnumCondition("FloatValueMode", (int)ValueModes.Random)]
		...
		[PLFEnumCondition("FloatValueMode", (int)ValueModes.Incremental)]
