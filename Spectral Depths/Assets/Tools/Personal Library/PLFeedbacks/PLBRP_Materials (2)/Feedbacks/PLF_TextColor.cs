...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_TextColor : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Target", true, 58, true)]
		/// the Text component to control
		[Tooltip(" Text component to control")]
		public Text TargetText;

		[PLFInspectorGroup("Color", true, 36)]
		...
		[PLFEnumCondition("ColorMode", (int)ColorModes.Interpolate, (int)ColorModes.Gradient)]
		public float Duration = 0.2f;
		/// the color to apply
		[Tooltip("the color to apply")]
		[PLFEnumCondition("ColorMode", (int)ColorModes.Instant)]
