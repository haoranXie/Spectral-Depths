...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_ImageTextureScale : PLF_Feedback
	{
		...
		{
			_newValue.x = PLFeedbacksHelpers.Remap(ScaleCurve.Evaluate(time), 0f, 1f, RemapZero.x, RemapOne.x);
			_newValue.y = PLFeedbacksHelpers.Remap(ScaleCurve.Evaluate(time), 0f, 1f, RemapZero.y, RemapOne.y);
