...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_ShaderGlobal : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Shader Global", true, 24)]
		...
		[PLFEnumCondition("Mode", (int)Modes.SetGlobalColor, (int)Modes.SetGlobalFloat, (int)Modes.SetGlobalInt, (int)Modes.SetGlobalMatrix, (int)Modes.SetGlobalTexture, (int)Modes.SetGlobalVector)]
		...
		[PLFEnumCondition("Mode", (int)Modes.SetGlobalColor)]
		...
		[PLFEnumCondition("Mode", (int)Modes.SetGlobalTexture)]
		...
		[PLFEnumCondition("Mode", (int)Modes.SetGlobalVector)]
		public Vector4 GlobalVector;
		/// a global shader keyword
		[Tooltip("a global shader keyword")] 
		[PLFEnumCondition("Mode", (int)Modes.EnableKeyword, (int)Modes.DisableKeyword)]
