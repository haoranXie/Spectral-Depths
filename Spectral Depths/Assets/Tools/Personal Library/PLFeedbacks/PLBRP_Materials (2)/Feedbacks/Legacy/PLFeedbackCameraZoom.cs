...
namespace SpectralDepths.Feedbacks
{
	...
	[FeedbackHelp("Define zoom properties : For will set the zoom to the specified parameters for a certain duration, " +
	              ...
	              "For this to work, you'll need to add a PLCameraZoom component to your Camera, or a PLCinemachineZoom if you're " +
	              "using virtual cameras.")]
	[FeedbackPath("Camera/Camera Zoom")]
	public class PLFeedbackCameraZoom : PLFeedback
	{
		...
		public PLCameraZoomModes ZoomMode = PLCameraZoomModes.For;
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData(Channel), Timing.TimescaleMode == TimescaleModes.Unscaled, false, RelativeFieldOfView);
		}
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData(Channel), Timing.TimescaleMode == TimescaleModes.Unscaled, stop:true);
		}
	}
}