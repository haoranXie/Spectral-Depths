...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_Rigidbody2D : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Rigidbody2D", true, 32, true)]
		...
		[PLFEnumCondition("Mode", (int)Modes.AddForce, (int)Modes.AddRelativeForce)]
		...
		[PLFEnumCondition("Mode", (int)Modes.AddTorque)]
