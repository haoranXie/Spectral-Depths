...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_SetActive : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Set Active Target", true, 12, true)]
		...
		[PLFInspectorGroup("States", true, 14)]
		...
		[PLFCondition("SetStateOnInit", true)]
		...
		[PLFCondition("SetStateOnPlay", true)]
		...
		[PLFCondition("SetStateOnStop", true)]
		...
		[PLFCondition("SetStateOnReset", true)]
		...
		[PLFCondition("SetStateOnSkip", true)]
