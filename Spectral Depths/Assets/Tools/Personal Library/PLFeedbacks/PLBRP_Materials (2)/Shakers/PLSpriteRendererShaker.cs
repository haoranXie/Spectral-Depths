...
{
	/// <summary>
	/// Add this to a SpriteRenderer to have it receive PLSpriteRendererShakeEvents from feedbacks or to shake it locally
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Renderer/PLSpriteRendererShaker")]
	[RequireComponent(typeof(SpriteRenderer))]
	public class PLSpriteRendererShaker : PLShaker
	{
		[PLInspectorGroup("SpriteRenderer", true, 39)]
		...
		[PLInspectorGroup("Color", true, 40)]
		...
		{
			base.StartListening();
			PLSpriteRendererShakeEvent.Register(OnMMSpriteRendererShakeEvent);
		}
		...
		{
			base.StopListening();
			PLSpriteRendererShakeEvent.Unregister(OnMMSpriteRendererShakeEvent);
		}

		public virtual void OnMMSpriteRendererShakeEvent(float shakeDuration, bool modifyColor, Gradient colorOverTime,
			bool flipX, bool flipY,
			float feedbacksIntensity = 1.0f, PLChannelData channelData = null, bool resetShakerValuesAfterShake = true, bool resetTargetValuesAfterShake = true,
	...
	/// <summary>
	/// An event used (usually from PLFeeedbackSpriteRenderer) to shake the values of a SpriteRenderer
	/// </summary>
	public struct PLSpriteRendererShakeEvent
	{
