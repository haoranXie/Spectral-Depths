...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	public class PLRotationShaker : PLShaker
	{
		...
		{
			base.StartListening();
			PLRotationShakeEvent.Register(OnMMRotationShakeEvent);
		}
		...
		{
			base.StopListening();
			PLRotationShakeEvent.Unregister(OnMMRotationShakeEvent);
		}
	}
	
	public struct PLRotationShakeEvent
	{
