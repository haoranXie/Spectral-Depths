...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioFilterLowPassShaker")]
	[RequireComponent(typeof(AudioLowPassFilter))]
	public class PLAudioFilterLowPassShaker : PLShaker
	{
		[PLInspectorGroup("Low Pass", true, 54)]
		...
		{
			base.StartListening();
			PLAudioFilterLowPassShakeEvent.Register(OnMMAudioFilterLowPassShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioFilterLowPassShakeEvent.Unregister(OnMMAudioFilterLowPassShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioFilterLowPassShakeEvent
	{
