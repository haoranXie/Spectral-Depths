...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioSourceStereoPanShaker")]
	[RequireComponent(typeof(AudioSource))]
	public class PLAudioSourceStereoPanShaker : PLShaker
	{
		[PLInspectorGroup("Stereo Pan", true, 57)]
		...
		{
			base.StartListening();
			PLAudioSourceStereoPanShakeEvent.Register(OnMMAudioSourceStereoPanShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioSourceStereoPanShakeEvent.Unregister(OnMMAudioSourceStereoPanShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioSourceStereoPanShakeEvent
	{
