...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Camera/PLCameraClippingPlanesShaker")]
	[RequireComponent(typeof(Camera))]
	public class PLCameraClippingPlanesShaker : PLShaker
	{
		[PLInspectorGroup("Clipping Planes", true, 31)]
		/// whether or not to add to the initial value
		[Tooltip("whether or not to add to the initial value")]
		public bool RelativeClippingPlanes = false;
        
		[PLInspectorGroup("Near Plane", true, 32)]
		...
		[PLInspectorGroup("Far Plane", true, 33)]
		/// the curve used to animate the intensity value on
		[Tooltip("the curve used to animate the intensity value on")]
		...
		{
			base.StartListening();
			PLCameraClippingPlanesShakeEvent.Register(OnMMCameraClippingPlanesShakeEvent);
		}
		...
		{
			base.StopListening();
			PLCameraClippingPlanesShakeEvent.Unregister(OnMMCameraClippingPlanesShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLCameraClippingPlanesShakeEvent
	{
