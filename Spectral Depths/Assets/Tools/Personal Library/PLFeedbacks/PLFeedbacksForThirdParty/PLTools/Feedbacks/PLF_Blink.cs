...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_Blink : PLF_Feedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetBlink = FindAutomatedTarget<PLBlink>();
		...
		[PLFInspectorGroup("Blink", true, 61, true)]
		...
		public List<PLBlink> ExtraTargetBlinks;
		...
		public PLF_Button GrabDurationFromBlinkButton;
		...
		{
			GrabDurationFromBlinkButton = new PLF_Button("Grab Duration From Blink Component", GrabDurationFromBlink);
		}
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			foreach (PLBlink blink in ExtraTargetBlinks)
			{
				HandleBlink(blink);
			}
		}
		...
		protected virtual void HandleBlink(PLBlink target)
		{
