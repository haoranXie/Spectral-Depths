...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_LoadScene : PLF_Feedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return PLFeedbacksInspectorColors.SceneColor; } }
		...
		/// - PLSceneLoadingManager : the simple, original PL way of loading scenes
		/// - PLAdditiveSceneLoadingManager : a more advanced way of loading scenes, with (way) more options
		public enum LoadingModes { Direct, PLSceneLoadingManager, PLAdditiveSceneLoadingManager, DirectAdditive }

		[PLFInspectorGroup("Scene Loading", true, 57, true)]
		...
		[Tooltip("the loading mode to use to load the destination scene : " +
		         ...
		         "- PLSceneLoadingManager : the simple, original PL way of loading scenes" +
		         "- PLAdditiveSceneLoadingManager : a more advanced way of loading scenes, with (way) more options")]
		public LoadingModes LoadingMode = LoadingModes.PLAdditiveSceneLoadingManager;
		...
		[PLFEnumCondition("LoadingMode", (int)LoadingModes.PLAdditiveSceneLoadingManager)]
		public PLAdditiveSceneLoadingManagerSettings.UnloadMethods UnloadMethod =
			PLAdditiveSceneLoadingManagerSettings.UnloadMethods.AllScenes;
		...
		[PLFInspectorGroup("Loading Scene Delays", true, 58)] 
		...
		[PLFInspectorGroup("Transitions", true, 59)] 
		...
		public PLTweenType EntryFadeTween = new PLTweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 1)));
		/// the tween to use on the exit fade
		[Tooltip("the tween to use on the exit fade")]
		public PLTweenType ExitFadeTween = new PLTweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 1)));
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (LoadingMode)
			{
				...
				case LoadingModes.DirectAdditive:
					...
					break;
				case LoadingModes.PLSceneLoadingManager:
					PLSceneLoadingManager.LoadScene(DestinationSceneName, LoadingSceneName);
					break;
				case LoadingModes.PLAdditiveSceneLoadingManager:
					PLAdditiveSceneLoadingManager.LoadScene(DestinationSceneName, LoadingSceneName, 
