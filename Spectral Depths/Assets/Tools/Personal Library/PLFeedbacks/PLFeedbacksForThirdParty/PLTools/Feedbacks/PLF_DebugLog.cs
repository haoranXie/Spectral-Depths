...
{
	/// <summary>
	/// This feedback will let you output a message to the console, using a custom PL debug method, or Log, Assertion, Error or Warning logs.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will let you output a message to the console, using a custom PL debug method, or Log, Assertion, Error or Warning logs.")]
	[FeedbackPath("Debug/Log")]
	public class PLF_DebugLog : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Debug", true, 17)]
		...
		[PLFEnumCondition("DebugLogMode", (int) DebugLogModes.DebugLogTime)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (DebugLogMode)
			{
				...
				case DebugLogModes.DebugLogTime:
					...
					PLDebug.DebugLogTime(DebugMessage, color, 3, DisplayFrameCount);
					break;
			}
		}
	}
