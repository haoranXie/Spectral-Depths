...
{
	/// <summary>
	/// A scriptable object used to store data for PLSoundManager play
	/// </summary>
	[Serializable]
	[CreateAssetMenu(menuName = "SpectralDepths/Audio/PLF_SoundData")]
	public class PLF_MMSoundManagerSoundData : ScriptableObject
	{
		[Header("Sound")]
		...
		[PLCondition("UseCustomRolloffCurve", true)]
		...
		[PLCondition("UseSpatialBlendCurve", true)]
		...
		[PLCondition("UseReverbZoneMixCurve", true)]
		...
		[PLCondition("UseSpreadCurve", true)]
