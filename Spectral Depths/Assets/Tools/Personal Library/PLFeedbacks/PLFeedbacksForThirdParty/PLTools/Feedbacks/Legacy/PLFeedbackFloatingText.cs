...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLFeedbackFloatingText : PLFeedback
	{
		...
		/// the channel to require a floating text spawn on. This has to match the Channel value in the Pooler settings of your chosen PLFloatingTextSpawner
		[Tooltip("the channel to require a floating text spawn on. This has to match the Channel value in the general settings of your chosen PLFloatingTextSpawner")]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLFloatingTextSpawnEvent.Trigger(ChannelData(Channel), _playPosition, _value, Direction, Intensity * intensityMultiplier, ForceLifetime, Lifetime, ForceColor, AnimateColorGradient, Timing.TimescaleMode == TimescaleModes.Unscaled);
