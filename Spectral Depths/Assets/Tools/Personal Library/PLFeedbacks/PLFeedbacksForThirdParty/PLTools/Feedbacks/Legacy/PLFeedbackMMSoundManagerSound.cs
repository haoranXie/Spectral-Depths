...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLFeedbackMMSoundManagerSound : PLFeedback
	{
		...
		[Header("Test")]
		[PLFInspectorButton("TestPlaySound")]
		public bool TestButton;
		[PLFInspectorButton("TestStopSound")]
		...
		protected virtual void PlaySound(AudioClip sfx, Vector3 position, float intensity)
		{
			...
			{
				if (PLSoundManager.Instance.FindByClip(sfx) != null)
				{
					return;    
				}
			}
