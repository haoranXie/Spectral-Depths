...
namespace SpectralDepths.Tools 
{
	...
	/// It's got an activation button, a run button, and an option to slow down time (this will require a PLTimeManager present in the scene)
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Camera/PLGhostCamera")]
	public class PLGhostCamera : MonoBehaviour
	{
		[Header("Speed")]
		...
		[PLCondition("UseMobileControls", true)]
		public GameObject LeftStickContainer;
		[PLCondition("UseMobileControls", true)]
		public GameObject RightStickContainer;
		[PLCondition("UseMobileControls", true)]
		public PLTouchJoystick LeftStick;
		[PLCondition("UseMobileControls", true)]
		public PLTouchJoystick RightStick;
		...
		protected virtual void ToggleSlowMotion()
		{
			...
			if (TimeAltered)
			{
				PLTimeScaleEvent.Trigger(PLTimeScaleMethods.For, TimescaleModifier, 1f, true, 5f, true);
			}
			else
			{
