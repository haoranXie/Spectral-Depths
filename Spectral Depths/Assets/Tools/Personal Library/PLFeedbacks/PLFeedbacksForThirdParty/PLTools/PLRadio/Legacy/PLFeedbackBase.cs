...
{
	public class PLFeedbackBaseTarget
	{
	...
	public abstract class PLFeedbackBase : PLFeedback
	{
		...
		protected List<PLFeedbackBaseTarget> _targets;
		...
		{
			_targets = new List<PLFeedbackBaseTarget>();
			FillTargets();
			InitializeTargets();
		}
		...
		protected virtual void InitializeTargets()
		{
			...
			foreach(PLFeedbackBaseTarget target in _targets)
			{
