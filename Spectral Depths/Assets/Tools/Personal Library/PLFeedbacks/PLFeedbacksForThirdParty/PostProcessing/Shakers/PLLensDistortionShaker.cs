...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLLensDistortionShaker")]
	#if PL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class PLLensDistortionShaker : PLShaker
	{
		...
		{
			base.StartListening();
			PLLensDistortionShakeEvent.Register(OnMMLensDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			PLLensDistortionShakeEvent.Unregister(OnMMLensDistortionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLLensDistortionShakeEvent
	{
