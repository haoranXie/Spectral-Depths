...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLBloomShaker")]
	#if PL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class PLBloomShaker : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Bloom Intensity", true, 45)]
		...
		[PLInspectorGroup("Bloom Threshold", true, 46)]
		...
		public virtual void OnBloomShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax,
			...
			float feedbacksIntensity = 1.0f, PLChannelData channelData = null, bool resetShakerValuesAfterShake = true, bool resetTargetValuesAfterShake = true, bool forwardDirection = true, TimescaleModes timescaleMode = TimescaleModes.Scaled, bool stop = false, bool restore = false)
		{
		...
		{
			base.StartListening();
			PLBloomShakeEvent.Register(OnBloomShakeEvent);
		}
		...
		{
			base.StopListening();
			PLBloomShakeEvent.Unregister(OnBloomShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLBloomShakeEvent
	{
