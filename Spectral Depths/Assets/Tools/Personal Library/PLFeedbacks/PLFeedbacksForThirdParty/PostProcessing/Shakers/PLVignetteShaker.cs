...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLVignetteShaker")]
	#if PL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class PLVignetteShaker : PLShaker
	{
		[PLInspectorGroup("Vignette Intensity", true, 53)]
		...
		[PLInspectorGroup("Vignette Color", true, 51)]
		...
		{
			base.StartListening();
			PLVignetteShakeEvent.Register(OnVignetteShakeEvent);
		}
		...
		{
			base.StopListening();
			PLVignetteShakeEvent.Unregister(OnVignetteShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLVignetteShakeEvent
	{
