...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLColorGradingShaker")]
	#if PL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class PLColorGradingShaker : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Post Exposure", true, 40)]
		...
		[PLInspectorGroup("Hue Shift", true, 49)]
		...
		[PLInspectorGroup("Saturation", true, 48)]
		...
		{
			base.StartListening();
			PLColorGradingShakeEvent.Register(OnMMColorGradingShakeEvent);
		}
		...
		{
			base.StopListening();
			PLColorGradingShakeEvent.Unregister(OnMMColorGradingShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLColorGradingShakeEvent
	{
