...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Color Grading active, and a PLColorGradingShaker component.
	/// </summary>
	[AddComponentMenu("")]
	...
	[FeedbackHelp("This feedback allows you to control color grading post exposure, hue shift, saturation and contrast over time. " +
	              "It requires you have in your scene an object with a PostProcessVolume " +
	              "with Color Grading active, and a PLColorGradingShaker component.")]
	public class PLF_ColorGrading : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Color Grading", true, 46)]
		...
		[PLFInspectorGroup("Post Exposure", true, 47)]
		...
		[PLFInspectorGroup("Hue Shift", true, 48)]
		...
		[PLFInspectorGroup("Saturation", true, 49)]
		...
		[PLFInspectorGroup("Contrast", true, 50)]
		/// the curve used to animate the focal length value on
		[Tooltip("the curve used to animate the focal length value on")]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLColorGradingShakeEvent.Trigger(ShakePostExposure, RemapPostExposureZero, RemapPostExposureOne, 
