...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Depth of Field active, and a PLDepthOfFieldShaker component.
	/// </summary>
	[AddComponentMenu("")]
	...
	#endif
	public class PLF_DepthOfField : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Depth Of Field", true, 51)]
		...
		[PLFInspectorGroup("Focus Distance", true, 52)]
		...
		[PLFInspectorGroup("Aperture", true, 53)]
		...
		[PLFInspectorGroup("Focal Length", true, 54)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLDepthOfFieldShakeEvent.Trigger(ShakeFocusDistance, FeedbackDuration, RemapFocusDistanceZero, RemapFocusDistanceOne,
