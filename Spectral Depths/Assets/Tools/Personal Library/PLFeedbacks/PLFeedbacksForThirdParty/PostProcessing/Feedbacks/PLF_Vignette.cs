...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Vignette active, and a PLVignetteShaker component.
	/// </summary>
	[AddComponentMenu("")]
	...
	[FeedbackHelp("This feedback allows you to control vignette intensity over time. " +
	              "It requires you have in your scene an object with a PostProcessVolume " +
	              "with Vignette active, and a PLVignetteShaker component.")]
	public class PLF_Vignette : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Vignette", true, 58)]
		...
		[PLFInspectorGroup("Intensity", true, 59)]
		...
		[PLFInspectorGroup("Vignette Color", true, 60)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLVignetteShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLVignetteShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLVignetteShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true);
		}
	}
}