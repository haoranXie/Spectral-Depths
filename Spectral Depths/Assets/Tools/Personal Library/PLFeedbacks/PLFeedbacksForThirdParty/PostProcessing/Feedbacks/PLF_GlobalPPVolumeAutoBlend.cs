...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	public class PLF_GlobalPPVolumeAutoBlend : PLF_Feedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetAutoBlend = FindAutomatedTarget<PLGlobalPostProcessingVolumeAutoBlend>();
		...
		[PLFInspectorGroup("PostProcess Volume Blend", true, 53, true)]
		/// the target auto blend to pilot with this feedback
		[Tooltip("the target auto blend to pilot with this feedback")]
		public PLGlobalPostProcessingVolumeAutoBlend TargetAutoBlend;
		/// the chosen mode
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			else
			{
				...
				TargetAutoBlend.TimeScale = (ComputedTimescaleMode == TimescaleModes.Scaled) ? PLGlobalPostProcessingVolumeAutoBlend.TimeScales.Scaled : PLGlobalPostProcessingVolumeAutoBlend.TimeScales.Unscaled;
				if (!NormalPlayDirection)
				{
