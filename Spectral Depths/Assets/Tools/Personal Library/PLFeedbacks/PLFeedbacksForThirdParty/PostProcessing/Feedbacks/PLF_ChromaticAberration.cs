...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Chromatic Aberration active, and a PLChromaticAberrationShaker component.
	/// </summary>
	[AddComponentMenu("")]
	...
	[FeedbackHelp("This feedback allows you to control chromatic aberration intensity over time. It requires you have in your scene an object with a PostProcessVolume " +
	              "with Chromatic Aberration active, and a PLChromaticAberrationShaker component.")]
	public class PLF_ChromaticAberration : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Chromatic Aberration", true, 44)]
		...
		[PLFInspectorGroup("Intensity", true, 45)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLChromaticAberrationShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLChromaticAberrationShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLChromaticAberrationShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true);
		}
	}
}