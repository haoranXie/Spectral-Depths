...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with MotionBlur active, and a PLMotionBlurShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	#if PL_URP
	...
	[FeedbackHelp("This feedback allows you to control motion blur intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with MotionBlur active, and a PLMotionBlurShaker_URP component.")]
	public class PLF_MotionBlur_URP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Motion Blur", true, 25)]
		...
		[PLFInspectorGroup("Intensity", true, 24)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLMotionBlurShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLMotionBlurShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop: true, channelData: ChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLMotionBlurShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore: true, channelData: ChannelData);
		}
	}
}