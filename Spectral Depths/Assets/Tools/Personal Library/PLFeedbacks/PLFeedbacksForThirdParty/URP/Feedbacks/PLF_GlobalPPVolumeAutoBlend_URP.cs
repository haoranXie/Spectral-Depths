...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	public class PLF_GlobalPPVolumeAutoBlend_URP : PLF_Feedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetAutoBlend = FindAutomatedTarget<PLGlobalPostProcessingVolumeAutoBlend_URP>();
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (TargetAutoBlend == null)
			{
				Debug.LogWarning(Owner.name + " : this PLFeedbackGlobalPPVolumeAutoBlend needs a TargetAutoBlend, please set one in its inspector.");
				return;
			}
			...
			{
				TargetAutoBlend.TimeScale = (ComputedTimescaleMode == TimescaleModes.Scaled) ? PLGlobalPostProcessingVolumeAutoBlend_URP.TimeScales.Scaled : PLGlobalPostProcessingVolumeAutoBlend_URP.TimeScales.Unscaled;
