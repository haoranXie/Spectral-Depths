...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Depth of Field active, and a PLDepthOfFieldShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	...
	#endif
	public class PLF_DepthOfField_URP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Depth Of Field", true, 49)]
		...
		[PLFInspectorGroup("Focus Distance", true, 50)]
		...
		[PLFInspectorGroup("Aperture", true, 51)]
		...
		[PLFInspectorGroup("Focal Length", true, 20)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLDepthOfFieldShakeEvent_URP.Trigger(ShakeFocusDistance, FeedbackDuration, RemapFocusDistanceZero, RemapFocusDistanceOne,
