...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Lens Distortion active, and a PLLensDistortionShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	#if PL_URP
	...
	[FeedbackHelp("This feedback allows you to control URP lens distortion intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Lens Distortion active, and a PLLensDistortionShaker_URP component.")]
	public class PLF_LensDistortion_URP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Lens Distortion", true, 22)]
		...
		[PLFInspectorGroup("Intensity", true, 23)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLLensDistortionShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLLensDistortionShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true, channelData: ChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLLensDistortionShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true, channelData: ChannelData);
		}
	}
}