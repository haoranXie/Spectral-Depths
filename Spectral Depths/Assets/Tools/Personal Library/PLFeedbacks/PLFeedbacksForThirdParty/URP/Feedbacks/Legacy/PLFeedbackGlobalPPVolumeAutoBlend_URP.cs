...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	public class PLFeedbackGlobalPPVolumeAutoBlend_URP : PLFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (TargetAutoBlend == null)
			{
				Debug.LogWarning(this.name + " : this PLFeedbackGlobalPPVolumeAutoBlend needs a TargetAutoBlend, please set one in its inspector.");
				return;
			}
