...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Color Adjustments active, and a PLColorAdjustmentsShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	...
	#endif
	public class PLF_ColorAdjustments_URP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Color Grading", true, 43)]
		...
		[PLFInspectorGroup("Post Exposure", true, 48)]
		...
		[PLFInspectorGroup("Hue Shift", true, 47)]
		...
		[PLFInspectorGroup("Saturation", true, 46)]
		...
		[PLFInspectorGroup("Contrast", true, 45)]
		/// the curve used to animate the focal length value on
		[Tooltip("the curve used to animate the focal length value on")]
		...
		[PLFInspectorGroup("Color Filter", true, 44)]
		...
		[Tooltip("the selected color filter mode :" +
		         ...
		         "gradient : evaluates the color over time on that gradient, from left to right," +
		         "interpolate : lerps from the current color to the destination one ")]
		public PLColorAdjustmentsShaker_URP.ColorFilterModes ColorFilterMode = PLColorAdjustmentsShaker_URP.ColorFilterModes.None;
		...
		[PLFEnumCondition("ColorFilterMode", (int)PLColorAdjustmentsShaker_URP.ColorFilterModes.Gradient)]
		[GradientUsage(true)]
		...
		[PLFEnumCondition("ColorFilterMode", (int) PLColorAdjustmentsShaker_URP.ColorFilterModes.Interpolate)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLColorAdjustmentsShakeEvent_URP.Trigger(ShakePostExposure, RemapPostExposureZero, RemapPostExposureOne,
