...
{
	/// <summary>
	/// This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume with Bloom active, and a PLBloomShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume " +
	              "with Bloom active, and a PLBloomShaker_URP component.")]
	#if PL_URP
	[FeedbackPath("PostProcess/Bloom URP")]
	#endif
	public class PLF_Bloom_URP : PLF_Feedback 
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float attenuation = 1.0f)
		{
			...
			PLBloomShakeEvent_URP.Trigger(ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, ShakeThreshold, RemapThresholdZero, RemapThresholdOne,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLBloomShakeEvent_URP.Trigger(ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, 
