...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	[FeedbackHelp("This feedback allows you to control Film Grain intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Film Grain active, and a PLFilmGrainShaker_URP component.")]
	public class PLFeedbackFilmGrain_URP : PLFeedback
	{
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLFilmGrainShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true, channelData:ChannelData(Channel));
