...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// It requires you have in your scene an object with a Volume with Bloom active, and a PLPaniniProjectionShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to control Panini Projection distance and crop to fit over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with PaniniProjection active, and a PLPaniniProjectionShaker_URP component.")]
	#if PL_URP
	[FeedbackPath("PostProcess/Panini Projection URP")]
	#endif
	public class PLF_PaniniProjection_URP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Panini Projection", true, 28)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLPaniniProjectionShakeEvent_URP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, intensityMultiplier, ChannelData, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLPaniniProjectionShakeEvent_URP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData: ChannelData, stop: true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLPaniniProjectionShakeEvent_URP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData: ChannelData, restore: true);
		}
	}
}