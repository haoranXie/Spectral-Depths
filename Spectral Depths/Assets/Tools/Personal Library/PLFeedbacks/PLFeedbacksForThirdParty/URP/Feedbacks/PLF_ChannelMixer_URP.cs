...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	public class PLF_ChannelMixer_URP : PLF_Feedback 
	{
		...
		[PLFInspectorGroup("Channel Mixer", true, 41)]
		...
		[PLFInspectorGroup("Green", true, 43)]
		...
		[PLFInspectorGroup("Blue", true, 44)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLChannelMixerShakeEvent_URP.Trigger(ShakeRed, RemapRedZero, RemapRedOne,
