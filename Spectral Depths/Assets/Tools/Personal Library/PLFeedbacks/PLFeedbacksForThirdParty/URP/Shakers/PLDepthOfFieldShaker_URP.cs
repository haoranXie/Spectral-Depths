...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLDepthOfFieldShaker_URP")]
	public class PLDepthOfFieldShaker_URP : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Focus Distance", true, 51)]
		...
		[PLInspectorGroup("Aperture", true, 52)]
		...
		[PLInspectorGroup("Focal Length", true, 53)]
		...
		{
			base.StartListening();
			PLDepthOfFieldShakeEvent_URP.Register(OnDepthOfFieldShakeEvent);
		}
		...
		{
			base.StopListening();
			PLDepthOfFieldShakeEvent_URP.Unregister(OnDepthOfFieldShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLDepthOfFieldShakeEvent_URP
	{
