...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLLensDistortionShaker_URP")]
	public class PLLensDistortionShaker_URP : PLShaker
	{
		[PLInspectorGroup("Lens Distortion Intensity", true, 51)]
		...
		{
			base.StartListening();
			PLLensDistortionShakeEvent_URP.Register(OnMMLensDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			PLLensDistortionShakeEvent_URP.Unregister(OnMMLensDistortionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLLensDistortionShakeEvent_URP
	{
