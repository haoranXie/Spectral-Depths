...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLPaniniProjectionShaker_URP")]
	public class PLPaniniProjectionShaker_URP : PLShaker
	{
		[PLInspectorGroup("Distance", true, 62)]
		...
		{
			base.StartListening();
			PLPaniniProjectionShakeEvent_URP.Register(OnPaniniProjectionShakeEvent);
		}
		...
		{
			base.StopListening();
			PLPaniniProjectionShakeEvent_URP.Unregister(OnPaniniProjectionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLPaniniProjectionShakeEvent_URP
	{
