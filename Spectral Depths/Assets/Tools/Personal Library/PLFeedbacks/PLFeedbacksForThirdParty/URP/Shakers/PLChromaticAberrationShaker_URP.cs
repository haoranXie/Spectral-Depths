...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLChromaticAberrationShaker_URP")]
	public class PLChromaticAberrationShaker_URP : PLShaker
	{
		[PLInspectorGroup("Chromatic Aberration Intensity", true, 45)]
		...
		{
			base.StartListening();
			PLChromaticAberrationShakeEvent_URP.Register(OnMMChromaticAberrationShakeEvent);
		}
		...
		{
			base.StopListening();
			PLChromaticAberrationShakeEvent_URP.Unregister(OnMMChromaticAberrationShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLChromaticAberrationShakeEvent_URP
	{
