...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLBloomShaker_URP")]
	public class PLBloomShaker_URP : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Bloom Intensity", true, 51)]
		...
		[PLInspectorGroup("Bloom Threshold", true, 52)]
		...
		{
			base.StartListening();
			PLBloomShakeEvent_URP.Register(OnBloomShakeEvent);
		}
		...
		{
			base.StopListening();
			PLBloomShakeEvent_URP.Unregister(OnBloomShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLBloomShakeEvent_URP
	{
