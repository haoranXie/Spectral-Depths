...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLMotionBlurShaker_URP")]
	public class PLMotionBlurShaker_URP : PLShaker
	{
		[PLInspectorGroup("Motion Blur Intensity", true, 61)]
		...
		{
			base.StartListening();
			PLMotionBlurShakeEvent_URP.Register(OnMotionBlurShakeEvent);
		}
		...
		{
			base.StopListening();
			PLMotionBlurShakeEvent_URP.Unregister(OnMotionBlurShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLMotionBlurShakeEvent_URP
	{
