...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLVignetteShaker_URP")]
	public class PLVignetteShaker_URP : PLShaker
	{
		[PLInspectorGroup("Vignette Intensity", true, 63)]
		...
		{
			base.StartListening();
			PLVignetteShakeEvent_URP.Register(OnVignetteShakeEvent);
		}
		...
		{
			base.StopListening();
			PLVignetteShakeEvent_URP.Unregister(OnVignetteShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLVignetteShakeEvent_URP
	{
