...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Exposure active, and a PLExposureShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	...
	[FeedbackHelp("This feedback allows you to control Exposure intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Exposure active, and a PLExposureShaker_HDRP component.")]
	public class PLFeedbackExposure_HDRP : PLFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLExposureShakeEvent_HDRP.Trigger(FixedExposure, FeedbackDuration, RemapFixedExposureZero, RemapFixedExposureOne, RelativeFixedExposure, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLExposureShakeEvent_HDRP.Trigger(FixedExposure, FeedbackDuration, RemapFixedExposureZero, RemapFixedExposureOne, RelativeFixedExposure, channelData:ChannelData(Channel), stop:true);
