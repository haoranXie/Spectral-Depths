...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with MotionBlur active, and a PLMotionBlurShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	#if PL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control motion blur intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with MotionBlur active, and a PLMotionBlurShaker_HDRP component.")]
	public class PLF_MotionBlur_HDRP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Motion Blur", true, 24)]
		...
		[PLFInspectorGroup("Intensity", true, 25)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLMotionBlurShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLMotionBlurShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne,
