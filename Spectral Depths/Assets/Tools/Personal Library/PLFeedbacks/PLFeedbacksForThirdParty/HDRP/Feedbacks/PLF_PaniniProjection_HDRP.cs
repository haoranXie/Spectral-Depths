...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// It requires you have in your scene an object with a Volume with Bloom active, and a PLPaniniProjectionShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to control Panini Projection distance and crop to fit over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with PaniniProjection active, and a PLPaniniProjectionShaker_HDRP component.")]
	#if PL_HDRP
	[FeedbackPath("PostProcess/Panini Projection HDRP")]
	#endif
	public class PLF_PaniniProjection_HDRP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Panini Projection", true, 26)]
		...
		[PLFInspectorGroup("Distance", true, 27)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLPaniniProjectionShakeEvent_HDRP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, intensityMultiplier, ChannelData, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLPaniniProjectionShakeEvent_HDRP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData:ChannelData, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLPaniniProjectionShakeEvent_HDRP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData:ChannelData, restore:true);
		}
	}
}