...
{	
	...
	/// with Channel Mixer active, and a PLChannelMixerShaker_HDRP component.	
	/// </summary>	
	[AddComponentMenu("")]	
	#if PL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control channel mixer's red, green and blue over time." +
	              "It requires you have in your scene an object with a Volume" +
	              "with Channel Mixer active, and a PL Channel Mixer HDRP component.")]
	public class PLF_ChannelMixer_HDRP : PLF_Feedback	
	{	
		...
		[PLFInspectorGroup("Color Grading", true, 10)]
		...
		[PLFInspectorGroup("Green", true, 12)]
		...
		[PLFInspectorGroup("Blue", true, 11)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLChannelMixerShakeEvent_HDRP.Trigger(ShakeRed, RemapRedZero, RemapRedOne,
