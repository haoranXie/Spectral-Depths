...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// It requires you have in your scene an object with a Volume with White Balance active, and a PLWhiteBalanceShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to control white balance temperature and tint over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with WhiteBalance active, and a PLWhiteBalanceShaker_HDRP component.")]
	#if PL_HDRP
	[FeedbackPath("PostProcess/White Balance HDRP")]
	#endif
	public class PLF_WhiteBalance_HDRP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("White Balance", true, 32)]
		...
		[PLFInspectorGroup("Temperature", true, 33)]
		...
		[PLFInspectorGroup("Tint", true, 34)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLWhiteBalanceShakeEvent_HDRP.Trigger(ShakeTemperature, FeedbackDuration, RemapTemperatureZero, RemapTemperatureOne,
