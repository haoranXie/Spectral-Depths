...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLVignetteShaker_HDRP")]
	public class PLVignetteShaker_HDRP : PLShaker
	{
		[Header("Intensity")]
		[PLInspectorGroup("Vignette Intensity", true, 46)]
		...
		{
			base.StartListening();
			PLVignetteShakeEvent_HDRP.Register(OnVignetteShakeEvent);
		}
		...
		{
			base.StopListening();
			PLVignetteShakeEvent_HDRP.Unregister(OnVignetteShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLVignetteShakeEvent_HDRP
	{
