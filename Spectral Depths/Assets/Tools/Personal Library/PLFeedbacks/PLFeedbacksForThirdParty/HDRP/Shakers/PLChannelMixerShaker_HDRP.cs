...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLChannelMixerShaker_HDRP")]
	public class PLChannelMixerShaker_HDRP : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Red", true, 42)]
		...
		[PLInspectorGroup("Green", true, 43)]
		...
		{
			base.StartListening();
			PLChannelMixerShakeEvent_HDRP.Register(OnMMChannelMixerShakeEvent);
		}
		...
		{
			base.StopListening();
			PLChannelMixerShakeEvent_HDRP.Unregister(OnMMChannelMixerShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLChannelMixerShakeEvent_HDRP
	{
