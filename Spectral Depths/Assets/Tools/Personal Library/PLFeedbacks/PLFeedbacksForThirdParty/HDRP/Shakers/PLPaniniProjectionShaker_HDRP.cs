...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLPaniniProjectionShaker_HDRP")]
	public class PLPaniniProjectionShaker_HDRP : PLShaker
	{
		[PLInspectorGroup("Panini Projection Distance", true, 49)]
		...
		{
			base.StartListening();
			PLPaniniProjectionShakeEvent_HDRP.Register(OnPaniniProjectionShakeEvent);
		}
		...
		{
			base.StopListening();
			PLPaniniProjectionShakeEvent_HDRP.Unregister(OnPaniniProjectionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLPaniniProjectionShakeEvent_HDRP
	{
