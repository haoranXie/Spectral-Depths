...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLLensDistortionShaker_HDRP")]
	public class PLLensDistortionShaker_HDRP : PLShaker
	{
		[PLInspectorGroup("Lens Distortion Intensity", true, 47)]
		...
		{
			base.StartListening();
			PLLensDistortionShakeEvent_HDRP.Register(OnMMLensDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			PLLensDistortionShakeEvent_HDRP.Unregister(OnMMLensDistortionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLLensDistortionShakeEvent_HDRP
	{
