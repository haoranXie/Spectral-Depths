...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLChromaticAberrationShaker_HDRP")]
	public class PLChromaticAberrationShaker_HDRP : PLShaker
	{
		[PLInspectorGroup("Chromatic Aberration Intensity", true, 44)]
		...
		{
			base.StartListening();
			PLChromaticAberrationShakeEvent_HDRP.Register(OnMMChromaticAberrationShakeEvent);
		}
		...
		{
			base.StopListening();
			PLChromaticAberrationShakeEvent_HDRP.Unregister(OnMMChromaticAberrationShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLChromaticAberrationShakeEvent_HDRP
	{
