...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLExposureShaker_HDRP")]
	public class PLExposureShaker_HDRP : PLShaker
	{
		[PLInspectorGroup("Exposure Intensity", true, 46)]
		...
		{
			base.StartListening();
			PLExposureShakeEvent_HDRP.Register(OnExposureShakeEvent);
		}
		...
		{
			base.StopListening();
			PLExposureShakeEvent_HDRP.Unregister(OnExposureShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLExposureShakeEvent_HDRP
	{
