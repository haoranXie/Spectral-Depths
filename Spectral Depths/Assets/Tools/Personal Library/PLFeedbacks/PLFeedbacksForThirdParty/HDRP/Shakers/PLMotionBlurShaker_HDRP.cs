...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLMotionBlurShaker_HDRP")]
	public class PLMotionBlurShaker_HDRP : PLShaker
	{
		[PLInspectorGroup("Motion Blur Intensity", true, 48)]
		...
		{
			base.StartListening();
			PLMotionBlurShakeEvent_HDRP.Register(OnMotionBlurShakeEvent);
		}
		...
		{
			base.StopListening();
			PLMotionBlurShakeEvent_HDRP.Unregister(OnMotionBlurShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLMotionBlurShakeEvent_HDRP
	{
