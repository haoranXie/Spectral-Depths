...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLWhiteBalanceShaker_HDRP")]
	public class PLWhiteBalanceShaker_HDRP : PLShaker
	{
		/// whether or not to add to the initial value
		[Tooltip("whether or not to add to the initial value")]
		public bool RelativeValues = true;

		[PLInspectorGroup("Temperature", true, 47)]
		...
		{
			base.StartListening();
			PLWhiteBalanceShakeEvent_HDRP.Register(OnWhiteBalanceShakeEvent);
		}
		...
		{
			base.StopListening();
			PLWhiteBalanceShakeEvent_HDRP.Unregister(OnWhiteBalanceShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLWhiteBalanceShakeEvent_HDRP
	{
