...
namespace SpectralDepths.Feedbacks
{
	...
	#endif
	public class PLF_TMPAlpha : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Alpha", true, 16)]
		...
		[PLFEnumCondition("AlphaMode", (int)AlphaModes.Interpolate, (int)AlphaModes.ToDestination)]
		public float Duration = 0.2f;
		/// the alpha to apply when in instant mode
		[Tooltip("the alpha to apply when in instant mode")]
		[PLFEnumCondition("AlphaMode", (int)AlphaModes.Instant)]
		...
		[PLFEnumCondition("AlphaMode", (int)AlphaModes.Interpolate)]
		...
		[PLFEnumCondition("AlphaMode", (int)AlphaModes.ToDestination)]
