...
namespace SpectralDepths.Feedbacks
{
	...
	#endif
	public class PLF_TMPWordSpacing : PLF_FeedbackBase
	{
		...
		[PLFInspectorGroup("Word Spacing", true, 15)]
		/// the curve to tween on
		[Tooltip("the curve to tween on")]
		[PLFEnumCondition("Mode", (int)PLFeedbackBase.Modes.OverTime)]
		public PLTweenType WordSpacingCurve = new PLTweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
