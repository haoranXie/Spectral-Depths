...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	public class PLF_NVClip : PLF_Feedback
	{
		#if MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED
		...
		[PLFInspectorGroup("Haptic Clip", true, 13, true)]
		...
		[PLFInspectorGroup("Level", true, 14)]
		...
		[PLFInspectorGroup("Frequency Shift", true, 15)]
