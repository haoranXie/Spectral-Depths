...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	public class PLF_NVContinuous : PLF_Feedback
	{
		#if MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED
		...
		[PLFInspectorGroup("Haptic Amplitude", true, 31)]
		...
		[PLFInspectorGroup("Haptic Frequency", true, 32)]
		...
		[PLFInspectorGroup("Duration", true, 33)]
		...
		[PLFInspectorGroup("Real-time Modulation", true, 34)]
		...
		[PLFCondition("UseRealTimeModulation", true)]
		...
		[PLFInspectorGroup("Settings", true, 16)]
		...
		public PLFeedbackNVSettings HapticSettings;
