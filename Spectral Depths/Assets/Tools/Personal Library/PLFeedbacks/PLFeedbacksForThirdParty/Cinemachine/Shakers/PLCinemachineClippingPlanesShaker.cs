...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Cinemachine/PLCinemachineClippingPlanesShaker")]
	#if PL_CINEMACHINE
	[RequireComponent(typeof(CinemachineVirtualCamera))]
	#endif
	public class PLCinemachineClippingPlanesShaker : PLShaker
	{
		[PLInspectorGroup("Clipping Planes", true, 45)]
		/// whether or not to add to the initial value
		public bool RelativeClippingPlanes = false;

		[PLInspectorGroup("Near Plane", true, 46)]
		...
		[PLInspectorGroup("Far Plane", true, 47)]
		/// the curve used to animate the intensity value on
		[Tooltip("the curve used to animate the intensity value on")]
