...
{
	/// <summary>
	/// Add this to a Cinemachine virtual camera and it'll let you control its orthographic size over time, can be piloted by a PLFeedbackCameraOrthographicSize
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Cinemachine/PLCinemachineOrthographicSizeShaker")]
	#if PL_CINEMACHINE
	[RequireComponent(typeof(CinemachineVirtualCamera))]
	#endif
	public class PLCinemachineOrthographicSizeShaker : PLShaker
	{
		[PLInspectorGroup("Orthographic Size", true, 43)]
