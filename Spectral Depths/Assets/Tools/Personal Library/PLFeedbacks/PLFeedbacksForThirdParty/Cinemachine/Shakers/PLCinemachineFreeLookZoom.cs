...
{
	/// <summary>
	/// This class will allow you to trigger zooms on your cinemachine camera by sending PLCameraZoomEvents from any other class
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Cinemachine/PLCinemachineFreeLookZoom")]
	#if PL_CINEMACHINE
	[RequireComponent(typeof(Cinemachine.CinemachineFreeLook))]
	#endif
	public class PLCinemachineFreeLookZoom : MonoBehaviour
	{
		[Header("Channel")]
		...
		public virtual void Zoom(PLCameraZoomModes mode, float newFieldOfView, float transitionDuration, 
			float duration, bool relative = false, PLTweenType tweenType = null)
		{
			if (_zooming)
			{
				return;
		...
		public virtual void OnCameraZoomEvent(PLCameraZoomModes mode, float newFieldOfView, float transitionDuration, float duration, 
			PLChannelData channelData, bool useUnscaledTime, bool stop = false, bool relative = false, bool restore = false, PLTweenType tweenType = null)
		{
