...
{
	/// <summary>
	/// This class, meant to be used in PLFeedbacks demos, will check for requirements, and output an
	/// error message if necessary.
	/// </summary>
	public class DemoPackageTester : MonoBehaviour
	{
		[PLFInformation("This component is only used to display an error in the console in case dependencies for this demo haven't been installed. You can safely remove it if you want, and typically you wouldn't want to keep that in your own game.", PLFInformationAttribute.InformationType.Warning, false)]
		...
		protected virtual void TestForDependencies()
		{
			...
			if (missingDependencies)
			{
				...
				{
					PLFDependencyInstaller.InstallFromPlay();
				}
			}
			#endif
		}
