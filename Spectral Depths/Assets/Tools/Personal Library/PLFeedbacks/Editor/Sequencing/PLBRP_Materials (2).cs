...
{
	/// <summary>
	/// Custom editor for PLSequencer, handles recalibration and sequencer display
	/// </summary>
	[CustomEditor(typeof(PLSequencer), true)]
	[CanEditMultipleObjects]
	public class PLSequencerEditor : Editor
	{
		protected PLSequencer _targetSequencer;
		...
		{
			_targetSequencer = (PLSequencer)target;
		...
		protected virtual void FillControlList()
		{
			...
			if (_targetSequencer.Sequence != null)
			{
				...
				foreach (PLSequenceTrack track in _targetSequencer.Sequence.SequenceTracks)
				{
