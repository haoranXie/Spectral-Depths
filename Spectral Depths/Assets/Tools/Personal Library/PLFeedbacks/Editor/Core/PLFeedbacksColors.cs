...
namespace SpectralDepths.Feedbacks
{
	...
	/// Color helpers
	/// </summary>
	public static class PLFeedbacksColors
	{
		...
		/// <returns></returns>
		public static Color PLRandomColor(this Color color, Color min, Color max)
		{
			Color c = new Color()
			{
		...
		public static Color PLColorize(this Color originalColor, Color targetColor, ColoringMode coloringMode, float lerpAmount = 1.0f)
		{
