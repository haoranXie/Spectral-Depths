...
{
	[CustomPropertyDrawer(typeof(PLFEnumConditionAttribute))]
	public class PLFEnumConditionAttributeDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			PLFEnumConditionAttribute enumConditionAttribute = (PLFEnumConditionAttribute)attribute;
		...
		private bool GetConditionAttributeResult(PLFEnumConditionAttribute enumConditionAttribute, SerializedProperty property)
		{
			bool enabled = true;
		...
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			...
			{
				/*int multiplier = 1; // this multiplier fixes issues in differing property spacing between PLFeedbacks and PLF_Player
				if (property.depth > 0)
				{
	...
	[CustomPropertyDrawer(typeof(PLFConditionAttribute))]
	public class PLFConditionAttributeDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			PLFConditionAttribute conditionAttribute = (PLFConditionAttribute)attribute;
		...
		private bool GetConditionAttributeResult(PLFConditionAttribute conditionAttribute, SerializedProperty property)
		{
			bool enabled = true;
			string propertyPath = property.propertyPath;
		...
		private bool ShouldDisplay(PLFConditionAttribute conditionAttribute, bool result)
		{
	...
	[CustomPropertyDrawer(typeof(PLFHiddenAttribute))]
	public class PLFHiddenAttributeDrawer : PropertyDrawer
	{
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			return 0f;
	...
	[CustomPropertyDrawer(typeof(PLFInformationAttribute))]
	/// <summary>
	/// This class allows the display of a message box (warning, info, error...) next to a property (before or after)
	/// </summary>
	public class PLFInformationAttributeDrawer : PropertyDrawer
	{
		...
		PLFInformationAttribute informationAttribute { get { return ((PLFInformationAttribute)attribute); } }
		...
		protected virtual bool HelpEnabled()
		{
			...
			{
				if (EditorPrefs.GetBool("PLShowHelpInInspectors"))
				{
					helpEnabled = true;
				}
			}
	...
	[CustomPropertyDrawer(typeof(PLFReadOnlyAttribute))]
	public class PLFReadOnlyAttributeDrawer : PropertyDrawer
	{
