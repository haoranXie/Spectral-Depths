...
namespace SpectralDepths.Feedbacks
{
	...
	[CustomEditor(typeof(PLWiggle), true)]
	public class PLWiggleEditor : Editor
	{
		...
		protected PLWiggle _mmWiggle;

		public bool StartWigglingAutomatically = true;

		protected virtual void OnEnable()
		{
			_mmWiggle = (PLWiggle)target;
		...
		public override void OnInspectorGUI()
		{
			...
			Undo.RecordObject(target, "Modified PLWiggle");            
		...
		protected virtual void DrawValueEditor(string title, SerializedProperty propertyActive, WiggleEditorProperties editorProperties, WiggleTypes wiggleType)
		{
			...
			Rect headerRect = PLFeedbackStyling.DrawSimpleHeader(
