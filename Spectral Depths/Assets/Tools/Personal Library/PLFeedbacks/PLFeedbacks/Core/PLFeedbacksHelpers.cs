...
{
	[AddComponentMenu("")]
	public class PLFeedbacksHelpers : MonoBehaviour
	{
		/// <summary>
		...
		/// <summary>
		/// A helper used to migrate values from an AnimationCurve field to a PLTweenType, useful when updating
		/// old feedbacks to use them without losing legacy values 
		/// </summary>
		/// <param name="oldCurve"></param>
		/// <param name="newTweenType"></param>
		/// <param name="owner"></param>
		public static void MigrateCurve(AnimationCurve oldCurve, PLTweenType newTweenType, PLF_Player owner)
		{
			if ((oldCurve.keys.Length > 0) && (!newTweenType.Initialized))
			{
				newTweenType.Curve = oldCurve;
				newTweenType.PLTweenDefinitionType = PLTweenDefinitionTypes.AnimationCurve;
				oldCurve = null;
	...
	public class PLFReadOnlyAttribute : PropertyAttribute { }

	[System.AttributeUsage(System.AttributeTargets.Field)]
	public class PLFInspectorButtonAttribute : PropertyAttribute
	{
		public readonly string MethodName;

		public PLFInspectorButtonAttribute(string MethodName)
		{
	...
	public class PLFEnumConditionAttribute : PropertyAttribute
	{
		...
		public PLFEnumConditionAttribute(string conditionBoolean, params int[] enumValues)
		{
	...
	#if UNITY_EDITOR
	[CustomPropertyDrawer(typeof(PLFInspectorButtonAttribute))]
	public class PLFInspectorButtonPropertyDrawer : PropertyDrawer
	{
		private MethodInfo _eventMethodInfo = null;

		public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
		{
			PLFInspectorButtonAttribute inspectorButtonAttribute = (PLFInspectorButtonAttribute)attribute;
	...
	public class PLFInformationAttribute : PropertyAttribute
	{
		...
		public PLFInformationAttribute(string message, InformationType type, bool messageAfterProperty)
		{
	...
	public class PLFHiddenAttribute : PropertyAttribute { }
	...
	public class PLFConditionAttribute : PropertyAttribute
	{
		public string ConditionBoolean = "";
		public bool Hidden = false;
		public bool Negative = false;

		public PLFConditionAttribute(string conditionBoolean)
		{
		...
		public PLFConditionAttribute(string conditionBoolean, bool hideInInspector)
		{
			this.ConditionBoolean = conditionBoolean;
		...
		public PLFConditionAttribute(string conditionBoolean, bool hideInInspector, bool negative)
		{
			this.ConditionBoolean = conditionBoolean;
			this.Hidden = hideInInspector;
	...
	public class PLFVectorAttribute : PropertyAttribute
	{
		public readonly string[] Labels;

		public PLFVectorAttribute(params string[] labels)
		{
			Labels = labels;
		}
	}
	...
	#if UNITY_EDITOR
	[CustomPropertyDrawer(typeof(PLFVectorAttribute))]
	public class PLVectorLabelsAttributeDrawer : PropertyDrawer
	{
		...
		{
			PLFVectorAttribute vector = (PLFVectorAttribute)attribute;
		...
		protected T[] DrawFields<T>(Rect rect, T[] vector, string mainLabel, System.Func<Rect, GUIContent, T, T> fieldDrawer, PLFVectorAttribute vectors)
		{
			T[] result = vector;
	...
	public class PLFHiddenPropertiesAttribute : Attribute
	{
		public string[] PropertiesNames;

		public PLFHiddenPropertiesAttribute(params string[] propertiesNames)
		{
	...
	/// </summary>
	[AttributeUsage(AttributeTargets.Field | AttributeTargets.Property | AttributeTargets.Class | AttributeTargets.Struct, Inherited = true)]
	public class PLFInspectorGroupAttribute : PropertyAttribute
	{
		...
		public PLFInspectorGroupAttribute(string groupName, bool groupAllFieldsUntilNextGroupAttribute = false, int groupColorIndex = 24, bool requiresSetup = false, bool closedByDefault = false)
		{
	...
	public static class PLFeedbackStaticMethods
	{
		...
		public static Type PLFGetTypeByName(string name)
		{
		...
		/// <param name="this"></param>
		/// <returns></returns>
		public static T PLFGetComponentNoAlloc<T>(this GameObject @this) where T : Component
		{
		...
		/// <returns></returns>
		public static object PLFGetObjectValue(this SerializedProperty property)
		{
			if (property == null)
			{
				return null;
			...
			foreach (var element in elements)
			{
				if (!element.Contains("["))
				{
					targetObject = PLFGetPropertyValue(targetObject, element);
				}
				else
				{
					string elementName = element.Substring(0, element.IndexOf("["));
					int elementIndex = System.Convert.ToInt32(element.Substring(element.IndexOf("[")).Replace("[", "").Replace("]", ""));
					targetObject = PLFGetPropertyValue(targetObject, elementName, elementIndex);
				}
			}
			return targetObject;
		}
        
		private static object PLFGetPropertyValue(object source, string propertyName)
		{
			if (source == null)
			{
				return null;
		...
		private static object PLFGetPropertyValue(object source, string propertyName, int index)
		{
			var enumerable = PLFGetPropertyValue(source, propertyName) as System.Collections.IEnumerable;
			if (enumerable == null)
			{
				return null;
			}
	...
	public static class PLF_FieldInfo
	{
		public static Dictionary<int, List<FieldInfo>> FieldInfoList = new Dictionary<int, List<FieldInfo>>();

        
		public static int GetFieldInfo(PLF_Feedback target, out List<FieldInfo> fieldInfoList)
		{
