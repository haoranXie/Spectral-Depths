...
{
	/// <summary>
	/// A PLSequencer with ready made slots to play PLFeedbacks
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Sequencing/PLFeedbacksSequencer")]
	public class PLFeedbacksSequencer : PLSequencer
	{
		/// the list of audio clips to play (one per track)
		[Tooltip("the list of audio clips to play (one per track)")]
		public List<PLFeedbacks> Feedbacks;
