...
{
	/// <summary>
	/// A PLSequencer with ready made slots to play sounds
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Sequencing/PLSoundSequencer")]
	public class PLSoundSequencer : PLSequencer
	{
