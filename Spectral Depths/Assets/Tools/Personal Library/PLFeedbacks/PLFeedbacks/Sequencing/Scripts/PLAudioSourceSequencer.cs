...
{
	/// <summary>
	/// A PLSequencer with ready made slots to play AudioSources
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Sequencing/PLAudioSourceSequencer")]
	public class PLAudioSourceSequencer : PLSequencer
	{
