...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	public struct PLFloatingTextSpawnEvent
	{
		...
		public delegate void Delegate(PLChannelData channelData, Vector3 spawnPosition, string value, Vector3 direction, float intensity,
		...
		static public void Trigger(PLChannelData channelData, Vector3 spawnPosition, string value, Vector3 direction, float intensity,
			bool forceLifetime = false, float lifetime = 1f, bool forceColor = false, Gradient animateColorGradient = null, bool useUnscaledTime = false)
		{
	...
	/// It requires as input a PLFloatingText object.
	/// </summary>
	public class PLFloatingTextSpawner : PLMonoBehaviour
	{
		...
		[PLInspectorGroup("General Settings", true, 10)]
		...
		[PLInspectorGroup("Pooler", true, 24)]
		...
		public PLFloatingText PooledSimpleMMFloatingText;
		/// the prefabs to spawn (ignored if in simple mode)
		[Tooltip("the prefabs to spawn (ignored if in simple mode)")]
		public List<PLFloatingText> PooledMultipleMMFloatingText;
		...
		[PLInspectorGroup("Spawn Settings", true, 14)]
		...
		[PLInspectorGroup("Animate Position", true, 15)] 
		...
		[PLInspectorGroup("Facing Directions", true, 16)]
		...
		[PLEnumCondition("AlignmentMode", (int)AlignmentModes.Fixed)]
		...
		[PLCondition("AlwaysFaceCamera", true)]
		...
		[PLInspectorGroup("Animate Scale", true, 46)]
		...
		[PLInspectorGroup("Animate Color", true, 55)]
		...
		[PLInspectorGroup("Animate Opacity", true, 45)]
		...
		[PLCondition("AnimateOpacity", true)]
		...
		[PLInspectorGroup("Intensity Multipliers", true, 45)]
		...
		[PLCondition("IntensityImpactsLifetime", true)]
		...
		[PLCondition("IntensityImpactsMovement", true)]
		...
		[PLCondition("IntensityImpactsScale", true)]
		public float IntensityScaleMultiplier = 1f;

		[PLInspectorGroup("Debug", true, 12)]
		...
		[PLInspectorButton("TestSpawnOne")]
		...
		[PLInspectorButton("TestSpawnMany")]
		public bool TestSpawnManyBtn;
        
		protected PLObjectPooler _pooler;
		protected PLFloatingText _floatingText;
		...
		protected virtual void InstantiateSimplePool()
		{
			...
			PLSimpleObjectPooler simplePooler = newPooler.AddComponent<PLSimpleObjectPooler>();
		...
		protected virtual void InstantiateMultiplePool()
		{
			...
			newPooler.transform.SetParent(this.transform);
			PLMultipleObjectPooler multiplePooler = newPooler.AddComponent<PLMultipleObjectPooler>();
			multiplePooler.Pool = new List<PLMultipleObjectPoolerObject>();
			foreach (PLFloatingText obj in PooledMultipleMMFloatingText)
			{
				PLMultipleObjectPoolerObject item = new PLMultipleObjectPoolerObject();
			...
			bool forceLifetime = false, float lifetime = 1f, bool forceColor = false, Gradient animateColorGradient = null)
		{
			...
			_spawnOffset = PLMaths.RandomVector3(SpawnOffsetMin, SpawnOffsetMax);
			...
			_floatingText = nextGameObject.PLGetComponentNoAlloc<PLFloatingText>();
		...
		/// <param name="forceColor"></param>
		/// <param name="animateColorGradient"></param>
		public virtual void OnMMFloatingTextSpawnEvent(PLChannelData channelData, Vector3 spawnPosition, string value, Vector3 direction, float intensity,
			bool forceLifetime = false, float lifetime = 1f, bool forceColor = false, Gradient animateColorGradient = null, bool useUnscaledTime = false)
		{
		...
		{
			PLFloatingTextSpawnEvent.Register(OnMMFloatingTextSpawnEvent);
		}
		...
		{
			PLFloatingTextSpawnEvent.Unregister(OnMMFloatingTextSpawnEvent);
		}
