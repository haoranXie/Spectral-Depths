...
namespace SpectralDepths.Feedbacks
{
	...
	/// You can also use it to broadcast a PLLookAtShake event, that PLLookAtShakers on the right channel will be able to listen for and act upon 
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will let you animate the rotation of a transform to look at a target over time. You can also use it to broadcast a PLLookAtShake event, that PLLookAtShakers on the right channel will be able to listen for and act upon.")]
	[FeedbackPath("Transform/LookAt")]
	public class PLF_LookAt : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Look at settings", true, 37, true)]
		...
		[PLFInspectorGroup("What we want to rotate", true, 37, true)]
		...
		[PLFEnumCondition("Mode", (int)Modes.Direct)]
		...
		[PLFEnumCondition("Mode", (int)Modes.Event)]
		...
		[PLFInspectorGroup("What we want to look at", true, 37, true)]
		...
		[PLFEnumCondition("LookAtTargetMode", (int)LookAtTargetModes.Transform)]
		...
		[PLFEnumCondition("LookAtTargetMode", (int)LookAtTargetModes.TargetWorldPosition)]
		...
		[PLFEnumCondition("LookAtTargetMode", (int)LookAtTargetModes.Direction)]
		...
		protected virtual void InitiateLookAt(Vector3 position)
		{
			...
			switch (Mode)
			{
				case Modes.Direct:
					...
					break;
				case Modes.Event:
					PLLookAtShaker.PLLookAtShakeEvent.Trigger(Duration, LockXAxis, LockYAxis, LockZAxis, UpwardVector,
