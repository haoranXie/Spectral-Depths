...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_UnloadScene : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Unload Scene", true, 43, false)]
		...
		[PLFEnumCondition("Method", (int)Methods.BuildIndex)]
		public int BuildIndex = 0;

		/// the name of the scene to unload
		[Tooltip("the name of the scene to unload")]
		[PLFEnumCondition("Method", (int)Methods.SceneName)]
