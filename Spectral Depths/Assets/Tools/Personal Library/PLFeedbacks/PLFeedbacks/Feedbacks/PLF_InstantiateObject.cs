...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_InstantiateObject : PLF_Feedback
	{
		...
		[PLFCondition("RandomizePosition", true)]
		...
		[PLFInspectorGroup("Parent", true, 47)]
		...
		[PLFInspectorGroup("Object Pool", true, 40)]
		...
		[PLFCondition("CreateObjectPool", true)]
