...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_GraphicCrossFade : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Graphic Cross Fade", true, 54, true)]
		...
		[PLFEnumCondition("Mode", (int)Modes.Alpha)]
		public float TargetAlpha = 0.2f;
		/// the target color
		[Tooltip("the target color")]
		[PLFEnumCondition("Mode", (int)Modes.Color)]
