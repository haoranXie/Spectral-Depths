...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLFeedbackPause : PLFeedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return PLFeedbacksInspectorColors.PauseColor; } }
		#endif
		...
		[PLFCondition("RandomizePauseDuration", true)]
		...
		/// if this is true, you'll need to call the Resume() method on the host PLFeedbacks for this pause to stop, and the rest of the sequence to play
		[Tooltip("if this is true, you'll need to call the Resume() method on the host PLFeedbacks for this pause to stop, and the rest of the sequence to play")]
		...
		[PLFCondition("ScriptDriven", true)]
		...
		protected virtual IEnumerator PauseWait()
		{
			...
			{
				return PLFeedbacksCoroutine.WaitFor(PauseDuration);
			}
			else
			{
				return PLFeedbacksCoroutine.WaitForUnscaled(PauseDuration);
			}
		}
