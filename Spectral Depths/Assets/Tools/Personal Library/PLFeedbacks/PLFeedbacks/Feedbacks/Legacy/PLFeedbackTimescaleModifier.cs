...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLFeedbackTimescaleModifier : PLFeedback
	{
		...
		[PLFEnumCondition("Mode", (int)Modes.Shake, (int)Modes.Change)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				case Modes.Shake:
					PLTimeScaleEvent.Trigger(PLTimeScaleMethods.For, TimeScale, FeedbackDuration, TimeScaleLerp, TimeScaleLerpSpeed, false);
					break;
				case Modes.Change:
					PLTimeScaleEvent.Trigger(PLTimeScaleMethods.For, TimeScale, 0f, TimeScaleLerp, TimeScaleLerpSpeed, true);
					break;
				case Modes.Reset:
