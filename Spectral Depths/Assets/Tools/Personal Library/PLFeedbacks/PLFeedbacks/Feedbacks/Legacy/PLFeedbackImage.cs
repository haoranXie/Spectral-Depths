...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will let you change the color of a target Image over time. You can also use it to command one or many PLImageShakers.")]
	[FeedbackPath("UI/Image")]
	public class PLFeedbackImage : PLFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (Mode)
			{
				...
				case Modes.ShakerEvent:
					/*PLImageShakeEvent.Trigger(Duration, ModifyColor, ColorOverTime, 
					    feedbacksIntensity,
