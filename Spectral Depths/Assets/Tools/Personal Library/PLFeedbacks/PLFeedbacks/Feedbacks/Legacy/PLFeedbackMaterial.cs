...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLFeedbackMaterial : PLFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				Debug.LogError("[PLFeedbackMaterial on " + this.name + "] The Materials array is empty.");
				return;
			}
			...
			{
				Debug.LogError("[PLFeedbackMaterial on " + this.name + "] Attempting to switch to a null material.");
				return;
			}
