...
namespace SpectralDepths.Feedbacks
{
	...
	[FeedbackPath("Light")]
	public class PLFeedbackLight : PLFeedback
	{
		...
		{
			float intensity = PLFeedbacksHelpers.Remap(IntensityCurve.Evaluate(time), 0f, 1f, RemapIntensityZero, RemapIntensityOne);
			float range = PLFeedbacksHelpers.Remap(RangeCurve.Evaluate(time), 0f, 1f, RemapRangeZero, RemapRangeOne);
			float shadowStrength = PLFeedbacksHelpers.Remap(ShadowStrengthCurve.Evaluate(time), 0f, 1f, RemapShadowStrengthZero, RemapShadowStrengthOne);        
