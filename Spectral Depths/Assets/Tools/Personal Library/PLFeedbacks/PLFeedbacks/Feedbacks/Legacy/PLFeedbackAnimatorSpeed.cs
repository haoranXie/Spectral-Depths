...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLFeedbackAnimatorSpeed : PLFeedback 
	{
		...
		[PLFEnumCondition("Mode", (int)Modes.InstantThenReset, (int)Modes.OverTime)]
		...
		protected virtual IEnumerator ChangeSpeedCo()
		{
			...
			else if (Mode == Modes.OverTime)
			{
				...
				{
					float time = PLFeedbacksHelpers.Remap(GetTime() - _startedAt, 0f, Duration, 0f, 1f);
