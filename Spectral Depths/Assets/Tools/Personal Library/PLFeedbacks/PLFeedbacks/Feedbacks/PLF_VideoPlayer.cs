...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_VideoPlayer : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Video Player", true, 58, true)]
		...
		[PLFEnumCondition("VideoAction", (int)VideoActions.GoToFrame)]
		public long TargetFrame = 10;
		/// the new playback speed (between 0 and 10)
		[Tooltip("the new playback speed (between 0 and 10)")]
		[PLFEnumCondition("VideoAction", (int)VideoActions.SetPlaybackSpeed)]
		...
		[PLFEnumCondition("VideoAction", (int)VideoActions.SetDirectAudioMute, (int)VideoActions.SetDirectAudioVolume)]
		public int TrackIndex = 0;
		/// the new volume for the specified track, between 0 and 1
		[Tooltip("the new volume for the specified track, between 0 and 1")]
		[PLFEnumCondition("VideoAction", (int)VideoActions.SetDirectAudioVolume)]
		...
		[PLFEnumCondition("VideoAction", (int)VideoActions.SetDirectAudioMute)]
