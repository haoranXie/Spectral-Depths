...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will freeze the timescale for the specified duration (in seconds). I usually go with 0.01s or 0.02s, but feel free to tweak it to your liking. It requires a PLTimeManager in your scene to work.")]
	[FeedbackPath("Time/Freeze Frame")]
	public class PLF_FreezeFrame : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Freeze Frame", true, 63)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLFreezeFrameEvent.Trigger(FeedbackDuration);
		}
	}
}