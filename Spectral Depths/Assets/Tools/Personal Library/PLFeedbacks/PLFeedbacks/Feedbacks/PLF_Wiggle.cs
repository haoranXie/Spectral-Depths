...
{
	/// <summary>
	/// When played, this feedback will activate the Wiggle method of a PLWiggle object based on the selected settings, wiggling either its position, rotation, scale, or all of these.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback lets you trigger position, rotation and/or scale wiggles on an object equipped with a PLWiggle component, for the specified durations.")]
	[FeedbackPath("Transform/Wiggle")]
	public class PLF_Wiggle : PLF_Feedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetWiggle = FindAutomatedTarget<PLWiggle>();

		[PLFInspectorGroup("Target", true, 54, true)]
		/// the Wiggle component to target
		[Tooltip("the Wiggle component to target")]
		public PLWiggle TargetWiggle;
        
		[PLFInspectorGroup("Position", true, 55)]
		...
		[PLFInspectorGroup("Rotation", true, 56)]
		...
		[PLFInspectorGroup("Scale", true, 57)]
