...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_AudioSourcePitch : PLF_Feedback
	{
		...
		[PLFInspectorGroup("AudioSource Pitch", true, 77)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLAudioSourcePitchShakeEvent.Trigger(PitchTween, FeedbackDuration, RemapPitchZero, RemapPitchOne, RelativePitch,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLAudioSourcePitchShakeEvent.Trigger(PitchTween, FeedbackDuration, RemapPitchZero, RemapPitchOne, RelativePitch, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLAudioSourcePitchShakeEvent.Trigger(PitchTween, FeedbackDuration, RemapPitchZero, RemapPitchOne, RelativePitch, restore:true);
		}
	}
}