...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_AudioSourceVolume : PLF_Feedback
	{
		...
		[PLFInspectorGroup("AudioSource Volume", true, 87)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLAudioSourceVolumeShakeEvent.Trigger(VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, RelativeVolume, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLAudioSourceVolumeShakeEvent.Trigger(VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLAudioSourceVolumeShakeEvent.Trigger(VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, restore:true);
		}
	}
}