...
namespace SpectralDepths.Feedbacks
{
	...
	[FeedbackPath("Feedbacks/PLF Reference Holder")]
	public class PLF_ReferenceHolder : PLF_Feedback
	{
		...
		[PLFInspectorGroup("References", true, 37, true)]
		...
		/// whether or not to force this reference holder on all compatible feedbacks in the PLF Player's list
		[Tooltip("whether or not to force this reference holder on all compatible feedbacks in the PLF Player's list")] 
