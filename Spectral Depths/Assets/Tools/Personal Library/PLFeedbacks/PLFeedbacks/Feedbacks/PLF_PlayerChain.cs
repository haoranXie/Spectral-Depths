...
{
	/// <summary>
	/// This feedback allows you to chain any number of target PLF Players and play them in sequence, with optional delays before and after
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to chain any number of target PLF Players and play them in sequence, with optional delays before and after")]
	[FeedbackPath("Feedbacks/PLF Player Chain")]
	public class PLF_PlayerChain : PLF_Feedback
	{
		/// <summary>
		/// A class used to store and define items in a chain of PLF Players
		/// </summary>
		[Serializable]
		public class PlayerChainItem
		{
			/// the target PLF Player 
			[Tooltip("the target PLF Player")]
			public PLF_Player TargetPlayer;
			/// a delay in seconds to wait for before playing this PLF Player (x) and after (y)
			[Tooltip("a delay in seconds to wait for before playing this PLF Player (x) and after (y)")]
			[PLVector("Before", "After")]
		...
		/// the list of PLF Player that make up the chain. The chain's items will be played from index 0 to the last in the list
		[Tooltip("the list of PLF Player that make up the chain. The chain's items will be played from index 0 to the last in the list")]
