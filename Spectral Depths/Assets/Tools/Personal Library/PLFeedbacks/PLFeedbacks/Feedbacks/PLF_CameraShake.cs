...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("Define camera shake properties (duration in seconds, amplitude and frequency), and this will broadcast a PLCameraShakeEvent with these same settings. " +
	              "You'll need to add a PLCameraShaker on your camera for this to work (or a PLCinemachineCameraShaker component on your virtual camera if you're using Cinemachine). " +
	...
	public class PLF_CameraShake : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Camera Shake", true, 57)]
		...
		public PLCameraShakeProperties CameraShakeProperties = new PLCameraShakeProperties(0.1f, 0.2f, 40f);
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLCameraShakeEvent.Trigger(FeedbackDuration, CameraShakeProperties.Amplitude * intensityMultiplier, CameraShakeProperties.Frequency, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLCameraShakeStopEvent.Trigger(ChannelData);
		}
	}
}