...
namespace SpectralDepths.Feedbacks
{
	...
	[FeedbackPath("Light")]
	public class PLF_Light : PLF_Feedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return PLFeedbacksInspectorColors.LightColor; } }
		...
		[PLFInspectorGroup("Light", true, 37, true)]
		...
		[PLFEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ShakerEvent, (int)Modes.ToDestination)]
		...
		[PLFEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ShakerEvent, (int)Modes.Instant)]
		public bool RelativeValues = true;
		/// whether or not to reset shaker values after shake
		[Tooltip("whether or not to reset shaker values after shake")]
		[PLFEnumCondition("Mode", (int)Modes.ShakerEvent)]
		...
		[PLFInspectorGroup("Color", true, 38, true)]
		...
		[PLFEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ShakerEvent)]
		public Gradient ColorOverTime;
		/// the color to move to in instant mode
		[Tooltip("the color to move to in instant mode")]
		[PLFEnumCondition("Mode", (int)Modes.Instant, (int)Modes.ShakerEvent)]
		...
		[PLFInspectorGroup("Intensity", true, 39, true)]
		...
		[PLFEnumCondition("Mode", (int)Modes.Instant)]
		...
		[PLFInspectorGroup("Range", true, 40, true)]
		...
		[PLFInspectorGroup("Shadow Strength", true, 41, true)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (Mode)
			{
				...
				case Modes.ShakerEvent:
					PLLightShakeEvent.Trigger(FeedbackDuration, RelativeValues, ModifyColor, ColorOverTime, IntensityCurve,
		...
		protected virtual void SetLightValues(float time, float intensityMultiplier)
		{
			...
			{
				case Modes.OverTime:
					intensity = PLFeedbacksHelpers.Remap(IntensityCurve.Evaluate(time), 0f, 1f, RemapIntensityZero, RemapIntensityOne);
					range = PLFeedbacksHelpers.Remap(RangeCurve.Evaluate(time), 0f, 1f, RemapRangeZero, RemapRangeOne);
					shadowStrength = PLFeedbacksHelpers.Remap(ShadowStrengthCurve.Evaluate(time), 0f, 1f, RemapShadowStrengthZero, RemapShadowStrengthOne);    
