...
{
	/// <summary>
	/// This feedback lets you emit a ScaleShake event. This will be caught by PLScaleShakers (on the specified channel).
	...
	[FeedbackHelp("This feedback lets you emit a ScaleShake event. This will be caught by PLScaleShakers (on the specified channel)." +
	              " Scale shakers, as the name suggests, are used to shake the scale of a transform, along a direction, with optional noise and other fine control options.")]
	public class PLF_ScaleShake : PLF_Feedback
	{
		...
		public PLScaleShaker TargetShaker;
		
		[PLFInspectorGroup("Scale Shake", true, 28)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				PLScaleShakeEvent.Trigger(Duration, ShakeSpeed,  ShakeRange,  ShakeMainDirection,  RandomizeDirection,  ShakeAltDirection,  RandomizeDirectionOnPlay,  AddDirectionalNoise, 
