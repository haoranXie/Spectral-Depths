...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_DestinationTransform : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Target to animate", true, 61, true)]
		...
		public PLTweenType GlobalAnimationTween = new PLTweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
		/// the duration of the transition, in seconds
		[Tooltip("the duration of the transition, in seconds")]
		public float Duration = 0.2f;

		[PLFInspectorGroup("Axis Locks", true, 64)]
		...
		[PLFInspectorGroup("Separate Curves", true, 65)]
		...
		[PLFCondition("SeparatePositionCurve", true)]
		public PLTweenType AnimatePositionTween = new PLTweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
		...
		[PLFCondition("SeparateRotationCurve", true)]
		public PLTweenType AnimateRotationTween = new PLTweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
		...
		[PLFCondition("SeparateScaleCurve", true)]
		public PLTweenType AnimateScaleTween = new PLTweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
		...
		protected PLTweenType _animationTweenType;
		...
		{
			base.OnValidate();
			PLFeedbacksHelpers.MigrateCurve(GlobalAnimationCurve, GlobalAnimationTween, Owner);
			PLFeedbacksHelpers.MigrateCurve(AnimatePositionCurve, AnimatePositionTween, Owner);
			PLFeedbacksHelpers.MigrateCurve(AnimateRotationCurve, AnimateRotationTween, Owner);
			PLFeedbacksHelpers.MigrateCurve(AnimateScaleCurve, AnimateScaleTween, Owner);
		}
	}    
}