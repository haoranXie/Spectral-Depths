...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioSourceVolumeShaker")]
	[RequireComponent(typeof(AudioSource))]
	public class PLAudioSourceVolumeShaker : PLShaker
	{
		[PLInspectorGroup("Volume", true, 59)]
		...
		{
			base.StartListening();
			PLAudioSourceVolumeShakeEvent.Register(OnMMAudioSourceVolumeShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioSourceVolumeShakeEvent.Unregister(OnMMAudioSourceVolumeShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioSourceVolumeShakeEvent
	{
