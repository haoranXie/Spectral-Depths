...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioFilterEchoShaker")]
	[RequireComponent(typeof(AudioEchoFilter))]
	public class PLAudioFilterEchoShaker : PLShaker
	{
		[PLInspectorGroup("Echo", true, 52)]
		...
		{
			base.StartListening();
			PLAudioFilterEchoShakeEvent.Register(OnMMAudioFilterEchoShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioFilterEchoShakeEvent.Unregister(OnMMAudioFilterEchoShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioFilterEchoShakeEvent
	{
