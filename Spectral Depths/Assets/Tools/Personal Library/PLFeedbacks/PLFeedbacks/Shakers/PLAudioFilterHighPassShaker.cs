...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioFilterHighPassShaker")]
	[RequireComponent(typeof(AudioHighPassFilter))]
	public class PLAudioFilterHighPassShaker : PLShaker
	{
		[PLInspectorGroup("High Pass", true, 53)]
		...
		{
			base.StartListening();
			PLAudioFilterHighPassShakeEvent.Register(OnMMAudioFilterHighPassShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioFilterHighPassShakeEvent.Unregister(OnMMAudioFilterHighPassShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioFilterHighPassShakeEvent
	{
