...
{
	/// <summary>
	/// Add this to a camera and it'll let you control its field of view over time, can be piloted by a PLFeedbackCameraFieldOfView
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Camera/PLCameraFieldOfViewShaker")]
	[RequireComponent(typeof(Camera))]
	public class PLCameraFieldOfViewShaker : PLShaker
	{
		[PLInspectorGroup("Field of View", true, 34)]
		...
		{
			base.StartListening();
			PLCameraFieldOfViewShakeEvent.Register(OnMMCameraFieldOfViewShakeEvent);
		}
		...
		{
			base.StopListening();
			PLCameraFieldOfViewShakeEvent.Unregister(OnMMCameraFieldOfViewShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLCameraFieldOfViewShakeEvent
	{
