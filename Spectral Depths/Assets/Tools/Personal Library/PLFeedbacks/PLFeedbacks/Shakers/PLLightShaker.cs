...
{
	/// <summary>
	/// Add this to a light to have it receive PLLightShakeEvents from feedbacks or to shake it locally
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Lights/PLLightShaker")]
	[RequireComponent(typeof(Light))]
	public class PLLightShaker : PLShaker
	{
		[PLInspectorGroup("Light", true, 37)]
		...
		[PLInspectorGroup("Color", true, 41)]
		...
		[PLInspectorGroup("Intensity", true, 40)]
		...
		[PLInspectorGroup("Range", true, 39)]
		...
		[PLInspectorGroup("Shadow Strength", true, 38)]
		/// the range to apply to the light over time
		[Tooltip("the range to apply to the light over time")]
		...
		{
			base.StartListening();
			PLLightShakeEvent.Register(OnMMLightShakeEvent);
		}
		...
		{
			base.StopListening();
			PLLightShakeEvent.Unregister(OnMMLightShakeEvent);
		}
	...
	public struct PLLightShakeEvent
	{
