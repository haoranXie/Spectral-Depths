...
{
	/// <summary>
	/// Add this to a camera and it'll let you control its orthographic size over time, can be piloted by a PLFeedbackCameraOrthographicSize
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Camera/PLCameraOrthographicSizeShaker")]
	[RequireComponent(typeof(Camera))]
	public class PLCameraOrthographicSizeShaker : PLShaker
	{
		[PLInspectorGroup("Orthographic Size", true, 37)]
		...
		{
			base.StartListening();
			PLCameraOrthographicSizeShakeEvent.Register(OnMMCameraOrthographicSizeShakeEvent);
		}
		...
		{
			base.StopListening();
			PLCameraOrthographicSizeShakeEvent.Unregister(OnMMCameraOrthographicSizeShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLCameraOrthographicSizeShakeEvent 
	{
		...
		public delegate void Delegate(AnimationCurve animCurve, float duration, float remapMin, float remapMax, bool relativeValue = false,
			float feedbacksIntensity = 1.0f, PLChannelData channelData = null, bool resetShakerValuesAfterShake = true, bool resetTargetValuesAfterShake = true, bool forwardDirection = true, 
