...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioFilterDistortionShaker")]
	[RequireComponent(typeof(AudioDistortionFilter))]
	public class PLAudioFilterDistortionShaker : PLShaker
	{
		[PLInspectorGroup("Distortion", true, 51)]
		...
		{
			base.StartListening();
			PLAudioFilterDistortionShakeEvent.Register(OnMMAudioFilterDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioFilterDistortionShakeEvent.Unregister(OnMMAudioFilterDistortionShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioFilterDistortionShakeEvent
	{
