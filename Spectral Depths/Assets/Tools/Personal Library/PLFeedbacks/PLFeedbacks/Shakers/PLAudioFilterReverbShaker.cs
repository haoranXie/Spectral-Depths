...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioFilterReverbShaker")]
	[RequireComponent(typeof(AudioReverbFilter))]
	public class PLAudioFilterReverbShaker : PLShaker
	{
		[PLInspectorGroup("Reverb", true, 55)]
		...
		{
			base.StartListening();
			PLAudioFilterReverbShakeEvent.Register(OnMMAudioFilterReverbShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioFilterReverbShakeEvent.Unregister(OnMMAudioFilterReverbShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioFilterReverbShakeEvent
	{
