...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	public class PLScaleShaker : PLShaker
	{
		...
		{
			base.StartListening();
			PLScaleShakeEvent.Register(OnMMScaleShakeEvent);
		}
		...
		{
			base.StopListening();
			PLScaleShakeEvent.Unregister(OnMMScaleShakeEvent);
		}
	}
	
	public struct PLScaleShakeEvent
	{
