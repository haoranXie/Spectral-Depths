...
namespace SpectralDepths.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Audio/PLAudioSourcePitchShaker")]
	[RequireComponent(typeof(AudioSource))]
	public class PLAudioSourcePitchShaker : PLShaker
	{
		[PLInspectorGroup("Pitch", true, 57)]
		...
		{
			base.StartListening();
			PLAudioSourcePitchShakeEvent.Register(OnMMAudioSourcePitchShakeEvent);
		}
		...
		{
			base.StopListening();
			PLAudioSourcePitchShakeEvent.Unregister(OnMMAudioSourcePitchShakeEvent);
		}
	}
	...
	/// </summary>
	public struct PLAudioSourcePitchShakeEvent
	{
