...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLBloomShaker_HDRP")]
	public class PLBloomShaker_HDRP : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Bloom Intensity", true, 42)]
		...
		[PLInspectorGroup("Bloom Threshold", true, 43)]
		...
		public virtual void OnBloomShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax,
			...
			float attenuation = 1.0f, PLChannelData channelData = null, bool resetShakerValuesAfterShake = true, 
		...
		{
			base.StartListening();
			PLBloomShakeEvent_HDRP.Register(OnBloomShakeEvent);
		}
		...
		{
			base.StopListening();
			PLBloomShakeEvent_HDRP.Unregister(OnBloomShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLBloomShakeEvent_HDRP
	{
