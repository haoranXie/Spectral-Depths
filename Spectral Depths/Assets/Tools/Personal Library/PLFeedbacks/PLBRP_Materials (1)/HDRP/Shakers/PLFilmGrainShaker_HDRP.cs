...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLFilmGrainShaker_HDRP")]
	public class PLFilmGrainShaker_HDRP : PLShaker
	{
		[PLInspectorGroup("Film Grain Intensity", true, 47)]
		...
		{
			base.StartListening();
			PLFilmGrainShakeEvent_HDRP.Register(OnFilmGrainShakeEvent);
		}
		...
		{
			base.StopListening();
			PLFilmGrainShakeEvent_HDRP.Unregister(OnFilmGrainShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLFilmGrainShakeEvent_HDRP
	{
