...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Color Adjustments active, and a PLColorAdjustmentsShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	#if PL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control color adjustments' post exposure, hue shift, saturation and contrast over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Color Adjustments active, and a PLColorAdjustmentsShaker_HDRP component.")]
	public class PLF_ColorAdjustments_HDRP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Color Grading", true, 16)]
		...
		[PLFInspectorGroup("Post Exposure", true, 15)]
		...
		[PLFInspectorGroup("Hue Shift", true, 14)]
		...
		[PLFInspectorGroup("Saturation", true, 13)]
		...
		[PLFInspectorGroup("Contrast", true, 12)]
		/// the curve used to animate the focal length value on
		[Tooltip("the curve used to animate the focal length value on")]
		...
		[Tooltip("the selected color filter mode :" +
		         ...
		         "gradient : evaluates the color over time on that gradient, from left to right," +
		         "interpolate : lerps from the current color to the destination one ")]
		public PLColorAdjustmentsShaker_HDRP.ColorFilterModes ColorFilterMode = PLColorAdjustmentsShaker_HDRP.ColorFilterModes.None;
		...
		[PLFEnumCondition("ColorFilterMode", (int)PLColorAdjustmentsShaker_HDRP.ColorFilterModes.Gradient)]
		[GradientUsage(true)]
		...
		[PLFEnumCondition("ColorFilterMode", (int) PLColorAdjustmentsShaker_HDRP.ColorFilterModes.Interpolate)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLColorAdjustmentsShakeEvent_HDRP.Trigger(ShakePostExposure, RemapPostExposureZero, RemapPostExposureOne,
