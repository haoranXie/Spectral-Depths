...
{
	/// <summary>
	/// This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume with Bloom active, and a PLBloomShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume " +
	              "with Bloom active, and a PLBloomShaker_HDRP component.")]
	#if PL_HDRP
	[FeedbackPath("PostProcess/Bloom HDRP")]
	#endif
	public class PLF_Bloom_HDRP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Bloom", true, 3)]
		...
		[PLFInspectorGroup("Intensity", true, 4)]
		...
		[PLFInspectorGroup("Threshold", true, 5)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float attenuation = 1.0f)
		{
			...
			PLBloomShakeEvent_HDRP.Trigger(ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, ShakeThreshold, RemapThresholdZero, RemapThresholdOne,
