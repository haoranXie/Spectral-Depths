...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Lens Distortion active, and a PLLensDistortionShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	#if PL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control HDRP lens distortion intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Lens Distortion active, and a PLLensDistortionShaker_HDRP component.")]
	public class PLF_LensDistortion_HDRP : PLF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLLensDistortionShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLLensDistortionShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne,
