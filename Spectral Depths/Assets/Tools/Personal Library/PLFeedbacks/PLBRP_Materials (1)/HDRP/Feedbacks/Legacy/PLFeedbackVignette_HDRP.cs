...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	[FeedbackHelp("This feedback allows you to control vignette intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Vignette active, and a PLVignetteShaker_HDRP component.")]
	public class PLFeedbackVignette_HDRP : PLFeedback
	{
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLVignetteShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, channelData:ChannelData(Channel), stop:true);
