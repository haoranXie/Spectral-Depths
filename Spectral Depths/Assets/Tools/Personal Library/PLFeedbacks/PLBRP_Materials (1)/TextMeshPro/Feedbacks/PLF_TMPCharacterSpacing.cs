...
namespace SpectralDepths.Feedbacks
{
	...
	#endif
	public class PLF_TMPCharacterSpacing : PLF_FeedbackBase
	{
		...
		[PLFInspectorGroup("Character Spacing", true, 16)]
		/// the curve to tween on
		[Tooltip("the curve to tween on")]
		[PLFEnumCondition("Mode", (int)PLFeedbackBase.Modes.OverTime)]
		public PLTweenType CharacterSpacingCurve = new PLTweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
