...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Cinemachine/PLCinemachineZoom")]
	#if PL_CINEMACHINE
	[RequireComponent(typeof(Cinemachine.CinemachineVirtualCamera))]
	#endif
	public class PLCinemachineZoom : MonoBehaviour
	{
		[Header("Channel")]
		...
		public virtual void Zoom(PLCameraZoomModes mode, float newFieldOfView, float transitionDuration, float duration, bool useUnscaledTime, bool relative = false, PLTweenType tweenType = null)
		{
			if (_zooming)
			{
				return;
