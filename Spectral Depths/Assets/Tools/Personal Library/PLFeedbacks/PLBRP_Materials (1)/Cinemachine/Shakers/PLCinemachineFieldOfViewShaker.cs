...
{
	/// <summary>
	/// Add this to a Cinemachine virtual camera and it'll let you control its field of view over time, can be piloted by a PLFeedbackCameraFieldOfView
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/Cinemachine/PLCinemachineFieldOfViewShaker")]
	#if PL_CINEMACHINE
	[RequireComponent(typeof(CinemachineVirtualCamera))]
	#endif
	public class PLCinemachineFieldOfViewShaker : PLShaker
	{
		[PLInspectorGroup("Field of view", true, 41)]
