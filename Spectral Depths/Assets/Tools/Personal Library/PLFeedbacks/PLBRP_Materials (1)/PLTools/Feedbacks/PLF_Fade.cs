...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_Fade : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Fade", true, 43)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (_fadeType)
			{
				case FadeTypes.Custom:
					PLFadeEvent.Trigger(FeedbackDuration, TargetAlpha, Curve, ID, IgnoreTimeScale, _position);
					break;
				case FadeTypes.FadeIn:
					PLFadeInEvent.Trigger(FeedbackDuration, Curve, ID, IgnoreTimeScale, _position);
					break;
				case FadeTypes.FadeOut:
					PLFadeOutEvent.Trigger(FeedbackDuration, Curve, ID, IgnoreTimeScale, _position);
					break;
			}
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLFadeStopEvent.Trigger(ID, true);
		}
	}
}