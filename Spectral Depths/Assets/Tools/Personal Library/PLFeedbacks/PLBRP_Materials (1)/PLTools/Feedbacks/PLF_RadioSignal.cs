...
namespace SpectralDepths.Feedbacks
{
	...
	public class PLF_RadioSignal : PLF_Feedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetSignal = FindAutomatedTarget<PLRadioSignal>();

		[PLFInspectorGroup("Radio Signal", true, 72)]
