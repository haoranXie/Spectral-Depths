...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Film Grain active, and a PLFilmGrainShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	#if PL_URP
	...
	[FeedbackHelp("This feedback allows you to control Film Grain intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Film Grain active, and a PLFilmGrainShaker_URP component.")]
	public class PLF_FilmGrain_URP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Film Grain", true, 21)]
		...
		[PLFInspectorGroup("Intensity", true, 22)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLFilmGrainShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLFilmGrainShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true, channelData: ChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLFilmGrainShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true, channelData: ChannelData);
		}
	}
}