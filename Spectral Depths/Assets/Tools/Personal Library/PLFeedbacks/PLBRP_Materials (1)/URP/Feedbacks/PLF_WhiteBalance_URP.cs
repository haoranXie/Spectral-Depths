...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// It requires you have in your scene an object with a Volume with White Balance active, and a PLWhiteBalanceShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to control white balance temperature and tint over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with WhiteBalance active, and a PLWhiteBalanceShaker_URP component.")]
	#if PL_URP
	[FeedbackPath("PostProcess/White Balance URP")]
	#endif
	public class PLF_WhiteBalance_URP : PLF_Feedback
	{
		...
		[PLFInspectorGroup("White Balance", true, 29)]
		...
		[PLFInspectorGroup("Temperature", true, 29)]
		...
		[PLFInspectorGroup("Tint", true, 29)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLWhiteBalanceShakeEvent_URP.Trigger(ShakeTemperature, FeedbackDuration, RemapTemperatureZero, RemapTemperatureOne,
