...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLFilmGrainShaker_URP")]
	public class PLFilmGrainShaker_URP : PLShaker
	{
		[PLInspectorGroup("Film Grain Intensity", true, 51)]
		...
		{
			base.StartListening();
			PLFilmGrainShakeEvent_URP.Register(OnFilmGrainShakeEvent);
		}
		...
		{
			base.StopListening();
			PLFilmGrainShakeEvent_URP.Unregister(OnFilmGrainShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLFilmGrainShakeEvent_URP
	{
