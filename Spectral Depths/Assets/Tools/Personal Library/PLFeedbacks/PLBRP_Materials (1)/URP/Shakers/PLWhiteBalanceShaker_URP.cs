...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLWhiteBalanceShaker_URP")]
	public class PLWhiteBalanceShaker_URP : PLShaker
	{
		/// whether or not to add to the initial value
		[Tooltip("whether or not to add to the initial value")]
		public bool RelativeValues = true;

		[PLInspectorGroup("Temperature", true, 55)]
		...
		{
			base.StartListening();
			PLWhiteBalanceShakeEvent_URP.Register(OnWhiteBalanceShakeEvent);
		}
		...
		{
			base.StopListening();
			PLWhiteBalanceShakeEvent_URP.Unregister(OnWhiteBalanceShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLWhiteBalanceShakeEvent_URP
	{
