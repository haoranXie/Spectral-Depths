...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	#endif
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLChannelMixerShaker_URP")]
	public class PLChannelMixerShaker_URP : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Red", true, 43)]
		...
		[PLInspectorGroup("Green", true, 44)]
		...
		{
			base.StartListening();
			PLChannelMixerShakeEvent_URP.Register(OnMMChannelMixerShakeEvent);
		}
		...
		{
			base.StopListening();
			PLChannelMixerShakeEvent_URP.Unregister(OnMMChannelMixerShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLChannelMixerShakeEvent_URP
	{
