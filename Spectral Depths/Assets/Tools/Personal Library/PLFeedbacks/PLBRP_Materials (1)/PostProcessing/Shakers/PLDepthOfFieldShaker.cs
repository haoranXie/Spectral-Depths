...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLDepthOfFieldShaker")]
	#if PL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class PLDepthOfFieldShaker : PLShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[PLInspectorGroup("Focus Distance", true, 49)]
		...
		[PLInspectorGroup("Aperture", true, 50)]
		...
		[PLInspectorGroup("Focal Length", true, 51)]
		...
		{
			base.StartListening();
			PLDepthOfFieldShakeEvent.Register(OnDepthOfFieldShakeEvent);
		}
		...
		{
			base.StopListening();
			PLDepthOfFieldShakeEvent.Unregister(OnDepthOfFieldShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLDepthOfFieldShakeEvent
	{
