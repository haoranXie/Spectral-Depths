...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLChromaticAberrationShaker")]
	#if PL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class PLChromaticAberrationShaker : PLShaker
	{
		[PLInspectorGroup("Chromatic Aberration Intensity", true, 46)]
		...
		{
			base.StartListening();
			PLChromaticAberrationShakeEvent.Register(OnMMChromaticAberrationShakeEvent);
		}
		...
		{
			base.StopListening();
			PLChromaticAberrationShakeEvent.Unregister(OnMMChromaticAberrationShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PLChromaticAberrationShakeEvent
	{
