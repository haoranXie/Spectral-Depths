...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Feedbacks/Shakers/PostProcessing/PLGlobalPostProcessingVolumeAutoBlend")]
	#if PL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class PLGlobalPostProcessingVolumeAutoBlend : MonoBehaviour
	{
		...
		[Header("Blend")]
		/// the trigger mode for this PLGlobalPostProcessingVolumeAutoBlend
		/// Start : will play automatically on enable
		[Tooltip("the trigger mode for this PLGlobalPostProcessingVolumeAutoBlend")]
		...
		protected virtual void Update()
		{
			...
			{                
				float remapped = PLFeedbacksHelpers.Remap(timeElapsed, 0f, BlendDuration, 0f, 1f);
