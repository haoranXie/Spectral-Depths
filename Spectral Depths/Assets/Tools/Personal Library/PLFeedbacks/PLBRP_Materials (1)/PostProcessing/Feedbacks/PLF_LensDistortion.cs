...
namespace SpectralDepths.FeedbacksForThirdParty
{
	...
	/// with Lens Distortion active, and a PLLensDistortionShaker component.
	/// </summary>
	[AddComponentMenu("")]
	...
	[FeedbackHelp("This feedback allows you to control lens distortion intensity over time. " +
	              "It requires you have in your scene an object with a PostProcessVolume " +
	              "with Lens Distortion active, and a PLLensDistortionShaker component.")]
	public class PLF_LensDistortion : PLF_Feedback
	{
		...
		[PLFInspectorGroup("Lens Distortion", true, 56)]
		...
		[PLFInspectorGroup("Intensity", true, 57)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PLLensDistortionShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PLLensDistortionShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PLLensDistortionShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true);
		}
	}
}