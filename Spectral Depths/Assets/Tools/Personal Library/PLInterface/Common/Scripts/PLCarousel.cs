...
{	
	...
	/// </summary>
	public class PLCarousel : MonoBehaviour
	{
		[Header("Binding")]
		...
		public PLTouchButton LeftButton;
		/// the button that moves the carousel to the right
		public PLTouchButton RightButton;
		...
		protected virtual void Initialization()
		{
			...
			{ 
				_elementWidth = tr.gameObject.PLGetComponentNoAlloc<RectTransform>().sizeDelta.x;
				_contentLength++;
			}
