...
{
	/// <summary>
	/// A class used to display a reoderable list of PLTilemapGeneratorLayers
	/// </summary>
	[System.Serializable]
	public class PLTilemapGeneratorLayerList : PLReorderableArray<PLTilemapGeneratorLayer>
	{
	}
    
	/// <summary>
	/// A class used to store and edit the data of PLTilemapGenerator layers, which you can use and combine
	/// to generate unique and random grids
	/// </summary>
	[Serializable]
	public class PLTilemapGeneratorLayer
	{
		...
		[PLCondition("OverrideGridSize", true)]
		...
		public PLTilemapGenerator.GenerateMethods GenerateMethod = PLTilemapGenerator.GenerateMethods.Perlin;
		...
		[PLCondition("DoNotUseGlobalSeed", true)]
		...
		[PLEnumCondition("GenerateMethod", (int)PLTilemapGenerator.GenerateMethods.Full)]
		...
		[PLEnumCondition("GenerateMethod", (int)PLTilemapGenerator.GenerateMethods.Random)]
		...
		[PLEnumCondition("GenerateMethod", (int)PLTilemapGenerator.GenerateMethods.RandomWalkGround)]
		...
		[PLEnumCondition("GenerateMethod", (int)PLTilemapGenerator.GenerateMethods.RandomWalk)]
		...
		[PLEnumCondition("GenerateMethod", (int)PLTilemapGenerator.GenerateMethods.RandomWalkAvoider)]
		...
		[PLEnumCondition("GenerateMethod", (int) PLTilemapGenerator.GenerateMethods.Path)]
		...
		[PLEnumCondition("GenerateMethod", (int) PLTilemapGenerator.GenerateMethods.Path)]
		public PLGridGeneratorPath.Directions PathDirection = PLGridGeneratorPath.Directions.BottomToTop;
		...
		[PLEnumCondition("GenerateMethod", (int) PLTilemapGenerator.GenerateMethods.Copy)]
		...
		/// </summary>
		[Serializable]
		public struct PLTilemapGeneratorLayerSafeSpot
		{
		...
		public List<PLTilemapGeneratorLayerSafeSpot> SafeSpots;
		...
		public virtual void SetDefaults()
		{
			if (!Initialized)
			{
				GridWidth = 50;
				GridHeight = 50;
				GenerateMethod = PLTilemapGenerator.GenerateMethods.Perlin;
				RandomizeSeed = true;
				...
				PathDirection = PLGridGeneratorPath.Directions.BottomToTop;
				Initialized = true;
			}            
		}
	}
