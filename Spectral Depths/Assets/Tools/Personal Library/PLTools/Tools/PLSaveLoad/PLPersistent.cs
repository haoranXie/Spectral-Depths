...
namespace SpectralDepths.Tools
{
	...
	/// This inherits from PLPersistentBase and implements the IMMPersistent interface
	/// It's a good example of how to implement the interface's OnSave and OnLoad methods
	/// </summary>
	public class PLPersistent : PLPersistentBase
	{
		...
		/// <summary>
		/// On Save, we turn the object's transform data and active state to a Json string and return it to the PLPersistencyManager
		/// </summary>
		/// <returns></returns>
