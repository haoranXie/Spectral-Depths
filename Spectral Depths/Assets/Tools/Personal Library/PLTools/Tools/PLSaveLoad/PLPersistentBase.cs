...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("")]
	public class PLPersistentBase : MonoBehaviour, IMMPersistent
	{
		[Header("Save")] 
		...
		[PLInspectorButton("GenerateGuid")]
		...
		{
			return Resources.FindObjectsOfTypeAll<PLPersistentBase>().Count(x => x.GetGuid() == guid) == 1;
		}
