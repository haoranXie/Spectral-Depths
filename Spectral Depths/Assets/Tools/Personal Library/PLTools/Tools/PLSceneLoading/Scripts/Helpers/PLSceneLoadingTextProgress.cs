...
{	
	/// <summary>
	/// A very simple class, meant to be used within a PLSceneLoading screen, to update a Text
	/// based on loading progress
	/// </summary>
	public class PLSceneLoadingTextProgress : MonoBehaviour
	{
		...
		{
			float remappedValue = PLMaths.Remap(newValue, 0f, 1f, RemapMin, RemapMax);
			float displayValue = PLMaths.RoundToDecimal(remappedValue, NumberOfDecimals);
