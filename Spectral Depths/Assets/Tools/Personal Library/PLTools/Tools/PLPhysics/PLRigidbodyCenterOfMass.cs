...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLRigidbodyCenterOfMass : MonoBehaviour
	{
		...
		[PLInspectorButton("SetCenterOfMass")]
		...
		{
			_rigidbody = this.gameObject.PLGetComponentNoAlloc<Rigidbody>();
			_rigidbody2D = this.gameObject.PLGetComponentNoAlloc<Rigidbody2D>();
		}
		...
		protected virtual void OnDrawGizmosSelected()
		{
			...
			PLDebug.DrawGizmoPoint(_gizmoCenter, GizmoPointSize, Color.yellow);
		}
	}
}