...
{	
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Rigidbody Interface/PLRigidbodyInterface")]
	public class PLRigidbodyInterface : MonoBehaviour 
	{	
		/// <summary>
		...
		/// <summary>
		/// Gets a value indicating whether this <see cref="SpectralDepths.Tools.RigidbodyInterface"/> is kinematic.
		/// </summary>
