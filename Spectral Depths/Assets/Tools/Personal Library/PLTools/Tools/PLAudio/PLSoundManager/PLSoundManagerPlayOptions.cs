...
{
	/// <summary>
	/// A class used to store options for PLSoundManager play
	/// </summary>
	[Serializable]
	public struct PLSoundManagerPlayOptions
	{
		/// the track on which to play the sound
		public PLSoundManager.PLSoundManagerTracks MmSoundManagerTrack;
		...
		/// 
		/// </summary>
		public static PLSoundManagerPlayOptions Default
		{
			get
			{
				PLSoundManagerPlayOptions defaultOptions = new PLSoundManagerPlayOptions();
				defaultOptions.MmSoundManagerTrack = PLSoundManager.PLSoundManagerTracks.Sfx;
