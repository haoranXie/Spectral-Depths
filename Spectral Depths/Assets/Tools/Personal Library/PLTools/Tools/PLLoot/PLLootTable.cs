...
namespace  SpectralDepths.Tools
{
	...
	public class PLLootTable<T,V> where T:PLLoot<V>
	{
	...
	/// <summary>
	/// A PLLootTable implementation for GameObjects
	/// </summary>
	[System.Serializable]
	public class PLLootTableGameObject : PLLootTable<PLLootGameObject, GameObject> { } 
    
	/// <summary>
	/// A PLLootTable implementation for floats
	/// </summary>
	[System.Serializable]
	public class PLLootTableFloat : PLLootTable<PLLootFloat, float> { } 
    
	/// <summary>
	/// A PLLootTable implementation for strings
	/// </summary>
	[System.Serializable]
	public class PLLootTableString : PLLootTable<PLLootString, string> { } 
}