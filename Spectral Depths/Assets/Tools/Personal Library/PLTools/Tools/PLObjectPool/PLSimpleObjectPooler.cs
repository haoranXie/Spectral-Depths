...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Object Pool/PLSimpleObjectPooler")]
	public class PLSimpleObjectPooler : PLObjectPooler 
	{
		...
		public List<PLSimpleObjectPooler> Owner { get; set; }
