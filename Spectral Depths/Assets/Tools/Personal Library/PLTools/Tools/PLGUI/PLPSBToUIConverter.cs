...
{
	[AddComponentMenu("Spectral Depths/Tools/GUI/PLPSBToUIConverter")]
	public class PLPSBToUIConverter : MonoBehaviour
	{
		[Header("Target")]
		...
		[Header("Conversion")]
		[PLInspectorButton("ConvertToCanvas")]
