...
namespace SpectralDepths.Tools
{
	...
	/// This is a legacy class, and it's recommended to use PLProgressBar instead, it'll provide the same functionality
	/// (make sure you pick FillAmount as the FillMode)
	/// and much more options, such as delayed bars, events, bump, and more!
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/GUI/PLRadialProgressBar")]
	public class PLRadialProgressBar : MonoBehaviour 
	{
		...
		{
			_newPercent = PLMaths.Remap(currentValue,minValue,maxValue,StartValue,EndValue);
