...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLGizmo : MonoBehaviour 
	{
		/// <summary>
		...
		[PLEnumCondition("PositionMode", (int)PositionModes.Texture)]
		...
		[PLEnumCondition("GizmoType", (int)GizmoTypes.Collider)]
		...
		[PLEnumCondition("TextMode", (int)TextModes.CustomText)]
		...
		[PLCondition("DisplayText", true)]
		public Color TextColor = PLColors.ReunoYellow; 
		...
		public PLPropertyPicker TargetProperty;
