...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Movement/PLFollowTarget")]
	public class PLFollowTarget : MonoBehaviour
	{
		/// the possible update modes
		public enum UpdateModes { Update, FixedUpdate, LateUpdate }
		/// the possible follow modes
		public enum FollowModes { RegularLerp, PLLerp, PLSpring }
		...
		[PLCondition("FollowPosition", true)]
		...
		public FollowModes FollowPositionMode = FollowModes.PLLerp;
		...
		[PLEnumCondition("FollowPositionMode", (int)FollowModes.PLSpring)] 
		[Range(0.01f, 1.0f)]
		...
		[PLCondition("InterpolateRotation", true)]
		public FollowModes FollowRotationMode = FollowModes.PLLerp;
		...
		[PLCondition("InterpolateScale", true)]
		public FollowModes FollowScaleMode = FollowModes.PLLerp;
		...
		[PLCondition("AnchorToInitialPosition", true)]
		...
		protected virtual void FollowTargetPosition()
		{
			...
			if (InterpolatePosition)
			{
				...
				{
					case FollowModes.PLLerp:
						interpolatedDistance = PLMaths.Lerp(0f, trueDistance, FollowPositionSpeed, Time.deltaTime);
					...
					case FollowModes.RegularLerp:
						...
						this.transform.Translate(_direction * interpolatedDistance, Space.World);
						break;
					case FollowModes.PLSpring:
						_newPosition = this.transform.position;
						PLMaths.Spring(ref _newPosition, _newTargetPosition, ref _velocity, PositionSpringDamping, PositionSpringFrequency, FollowPositionSpeed, Time.deltaTime);
						if (_localSpace)
						{
		...
		protected virtual void FollowTargetRotation()
		{
			...
			if (InterpolateRotation)
			{
				...
				{
					case FollowModes.PLLerp:
						this.transform.rotation = PLMaths.Lerp(this.transform.rotation, _newTargetRotation, FollowRotationSpeed, Time.deltaTime);
						break;
					case FollowModes.RegularLerp:
		...
		protected virtual void FollowTargetScale()
		{
			...
			if (InterpolateScale)
			{
				...
				{
					case FollowModes.PLLerp:
						this.transform.localScale = PLMaths.Lerp(this.transform.localScale, _newScale, FollowScaleSpeed, Time.deltaTime);
						break;
					case FollowModes.RegularLerp:
