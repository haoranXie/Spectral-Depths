...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Movement/PLPreventPassingThrough2D")]
	public class PLPreventPassingThrough2D : MonoBehaviour 
	{
		...
		{ 
			...
			{ 
				...
				{
					_hitInfo = PLDebug.RayCast(_positionLastFrame, _lastMovement.normalized, movementMagnitude, ObstaclesLayerMask, Color.blue, true);	
				}
				else
				{
