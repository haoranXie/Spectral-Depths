...
namespace  SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLFaceDirection : MonoBehaviour
	{
		...
		/// the target to face
		[PLEnumCondition("FacingMode", (int) FacingModes.Target)]
		public Transform FacingTarget;
		/// the minimum distance to consider when computing the movement direction
		[PLEnumCondition("FacingMode", (int) FacingModes.MovementDirection)]
