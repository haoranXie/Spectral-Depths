...
namespace SpectralDepths.Tools
{
	...
	public class PLAim
	{
		...
		[Header("Control Mode")]
		[PLInformation("Pick a control mode : mouse (aims towards the pointer), primary movement (you'll aim towards the current input direction), or secondary movement (aims " +
		               "towards a second input axis, think twin stick shooters), and set minimum and maximum angles.", SpectralDepths.Tools.PLInformationAttribute.InformationType.Info, false)]
		...
		public virtual Vector2 GetCurrentAim()
		{
			...
			_currentAim = (_currentAim.magnitude == 0f) ? Vector2.zero : PLMaths.RotateVector2(Vector2.right, CurrentAngle);
			return _currentAim;
		}
