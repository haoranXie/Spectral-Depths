...
{
	public class PLPlotterGenerator : MonoBehaviour
	{
		public PLPlotter PlotterPrefab;
		...
		[PLInspectorButton("GeneratePlotters")]
		...
		protected virtual void GeneratePlotters()
		{
			...
			for (int i=0; i < methods.Length; i++)
			{
				...
				PLPlotter plotter = Instantiate(PlotterPrefab);
