...
namespace SpectralDepths.Tools
{
	...
	/// Animator extensions
	/// </summary>
	public static class PLAnimatorExtensions
	{
		/// <summary>
		...
		public static bool PLHasParameterOfType(this Animator self, string name, AnimatorControllerParameterType type)
		{
		...
		public static void AddAnimatorParameterIfExists(Animator animator, string parameterName, out int parameter, AnimatorControllerParameterType type, HashSet<int> parameterList)
		{
			...
			if (animator.PLHasParameterOfType(parameterName, type))
			{
		...
		{
			if (animator.PLHasParameterOfType(parameterName, AnimatorControllerParameterType.Bool))
			{
				animator.SetBool(parameterName, value);
			}
		}
		...
		{
			if (animator.PLHasParameterOfType(parameterName, AnimatorControllerParameterType.Trigger))
			{
				animator.SetTrigger(parameterName);
			}
		}
		...
		{
			if (animator.PLHasParameterOfType(parameterName, AnimatorControllerParameterType.Float))
			{
				animator.SetFloat(parameterName, value);
			}
		}
		...
		{
			if (animator.PLHasParameterOfType(parameterName, AnimatorControllerParameterType.Int))
			{
				animator.SetInteger(parameterName, value);
			}
		}
