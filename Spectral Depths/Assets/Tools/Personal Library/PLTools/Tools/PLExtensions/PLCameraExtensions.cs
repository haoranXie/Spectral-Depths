...
namespace SpectralDepths.Tools
{
	...
	/// Camera extensions
	/// </summary>
	public static class PLCameraExtensions
	{
		/// <summary>
		...
		/// <returns></returns>
		public static float PLCameraWorldSpaceWidth(this Camera camera, float depth = 0f)
		{
		...
		/// <param name="depth"></param>
		/// <returns></returns>
		public static float PLCameraWorldSpaceHeight(this Camera camera, float depth = 0f)
		{
			if (camera.orthographic)
			{
