...
{	
	...
	public class PLInput : MonoBehaviour 
	{
		...
		public class IMButton
		{
			...
			public PLStateMachine<PLInput.ButtonStates> State {get;protected set;}
			...
			public IMButton(string CharacterID, string buttonID, ButtonDownMethodDelegate btnDown = null, ButtonPressedMethodDelegate btnPressed = null, ButtonUpMethodDelegate btnUp = null) 
			{
				...
				State = new PLStateMachine<PLInput.ButtonStates> (null, false);
				State.ChangeState (PLInput.ButtonStates.Off);
			}
			...
			public virtual void TriggerButtonDown()
			{
				...
				{
					State.ChangeState(PLInput.ButtonStates.ButtonDown);
				}
				else
				{
					ButtonDownMethod();
			...
			public virtual void TriggerButtonPressed()
			{
				...
				{
					State.ChangeState(PLInput.ButtonStates.ButtonPressed);
				}
				else
				{
					ButtonPressedMethod();
			...
			public virtual void TriggerButtonUp()
			{
				...
				{
					State.ChangeState(PLInput.ButtonStates.ButtonUp);
				}
				else
				{
					ButtonUpMethod();
