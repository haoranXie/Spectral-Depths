...
namespace SpectralDepths.Tools
{
	...
	public struct PLSpeedTestItem
	{
		...
		public PLSpeedTestItem(string testID)
		{
			TestID = testID;
	...
	/// </summary>
	public static class PLSpeedTest 
	{
		private static readonly Dictionary<string, PLSpeedTestItem> _speedTests = new Dictionary<string, PLSpeedTestItem>();
		...
		public static void StartTest(string testID)
		{
			...
			PLSpeedTestItem item = new PLSpeedTestItem(testID);
		...
		public static void EndTest(string testID)
		{
			...
			UnityEngine.Debug.Log("<color=red>PLSpeedTest</color> [Test "+testID+"] test duration : "+elapsedTime+"s");
		}        
	}
}