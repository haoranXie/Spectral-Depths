...
{
	[Serializable]
	[AddComponentMenu("Spectral Depths/Tools/Vision/PLConeOfVision2D")]
	public class PLConeOfVision2D : MonoBehaviour
	{
		...
		{
			_direction = PLMaths.DirectionFromAngle2D(angle, 0f);
