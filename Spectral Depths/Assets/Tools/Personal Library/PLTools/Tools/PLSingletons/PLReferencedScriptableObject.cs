...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLReferencedScriptableObject<T> : ScriptableObject where T : ScriptableObject
	{
		private PLReferenceHolder<T> _instances;
	...
	public struct PLReferenceHolder<T> : IDisposable where T : class
	{
