...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLPersistentHumbleSingleton<T> : MonoBehaviour	where T : Component
	{
		...
		protected virtual void InitializeSingleton()
		{
			...
			foreach (T searched in check)
			{
				if (searched!=this)
				{
					...
					if (searched.GetComponent<PLPersistentHumbleSingleton<T>>().InitializationTime < InitializationTime)
					{
