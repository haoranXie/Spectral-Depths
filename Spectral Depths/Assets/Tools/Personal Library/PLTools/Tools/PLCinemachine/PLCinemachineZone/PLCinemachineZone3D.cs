...
namespace SpectralDepths.Tools
{
	...
	public class PLCinemachineZone3D : PLCinemachineZone
	{
		...
		protected override void SetupConfiner()
		{
			...
			_cinemachineConfiner = VirtualCamera.gameObject.PLGetComponentAroundOrAdd<CinemachineConfiner>();
		...
		protected virtual void OnTriggerEnter(Collider collider)
		{
			...
			if (TriggerMask.PLContains (collider.gameObject))
			{
				EnterZone();
			}
		}
