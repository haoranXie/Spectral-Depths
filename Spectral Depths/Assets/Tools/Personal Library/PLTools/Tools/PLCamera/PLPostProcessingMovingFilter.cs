...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public struct PLPostProcessingMovingFilterEvent
	{
		...
		public delegate void Delegate(PLTweenType curve, bool active, bool toggle, float duration, int channel = 0,
			bool stop = false, bool restore = false);

		static public void Trigger(PLTweenType curve, bool active, bool toggle, float duration, int channel = 0,
			bool stop = false, bool restore = false)
		{
	...
	/// Typically a moving filter should be made of a PLPostProcessingMovingFilter component, 
	...
	/// 
	/// Use : 
	/// PLPostProcessingMovingFilterEvent.Trigger(PLTween.PLTweenCurve.EaseInOutCubic, TrueOrFalse, Duration, ChannelID);
	/// 
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Camera/PLPostProcessingMovingFilter")]
	public class PLPostProcessingMovingFilter : MonoBehaviour
	{
		...
		protected virtual void MoveTowardsCurrentTarget()
		{
			...
			_newPosition.y =
				PLTween.Tween(currentTime - _lastMovementStartedAt, 0f, _duration, originY, targetY, Curve);
		...
		public virtual void OnMMPostProcessingMovingFilterEvent(PLTweenType curve, bool active, bool toggle,
		...
		/// <summary>
		/// On enable, we start listening to PLPostProcessingTriggerEvents
		/// </summary>
		protected virtual void OnEnable()
		{
			PLPostProcessingMovingFilterEvent.Register(OnMMPostProcessingMovingFilterEvent);
		}

		/// <summary>
		/// On disable, we stop listening to PLPostProcessingTriggerEvents
		/// </summary>
		protected virtual void OnDisable()
		{
			PLPostProcessingMovingFilterEvent.Unregister(OnMMPostProcessingMovingFilterEvent);
		}
		...
		{
			PLPostProcessingMovingFilterEvent.Trigger(new PLTweenType(PLTween.PLTweenCurve.EaseInOutCubic), false, true,
				TestDuration, 0);
		}
		...
		{
			PLPostProcessingMovingFilterEvent.Trigger(new PLTweenType(PLTween.PLTweenCurve.EaseInOutCubic), false,
		...
		{
			PLPostProcessingMovingFilterEvent.Trigger(new PLTweenType(PLTween.PLTweenCurve.EaseInOutCubic), true, false,
				TestDuration, 0);
		}
	}
}