...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Camera/PLAspectRatioSafeZones")]
	public class PLAspectRatioSafeZones : MonoBehaviour
	{
		[Header("Center")]
		...
		public Color CenterCrosshairColor = PLColors.Wheat;
		...
		[PLInspectorButton("AutoSetup")]
		public bool AutoSetupButton;

		public virtual void AutoSetup()
		{
			Ratios.Clear();
			Ratios.Add(new Ratio(true, new Vector2(16, 9), PLColors.DeepSkyBlue));
			Ratios.Add(new Ratio(true, new Vector2(16, 10), PLColors.GreenYellow));
			Ratios.Add(new Ratio(true, new Vector2(4, 3), PLColors.HotPink));
		}
	}
}