...
namespace SpectralDepths.Tools
{
	...
	public class PLLineRendererDriver : MonoBehaviour
	{
		...
		protected virtual void Initialization()
		{
			...
			if (!_countsMatch)
			{
				Debug.LogWarning(this.name + ", PLLineRendererDriver's Targets list doesn't have the same amount of entries as the LineRender's Positions array. It won't work.");
			}
		}
