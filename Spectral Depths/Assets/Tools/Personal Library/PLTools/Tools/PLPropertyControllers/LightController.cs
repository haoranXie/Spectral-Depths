...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Property Controllers/LightController")]
	public class LightController : MonoBehaviour
	{
		[Header("Binding")]
		[PLInformation("Use this component to control the properties of one or more lights at runtime. Plays well with a FloatController. " +
		               "This component will try to auto set the TargetLight if there's a Light component on this object.", SpectralDepths.Tools.PLInformationAttribute.InformationType.Info, false)]
