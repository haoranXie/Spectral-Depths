...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Property Controllers/FloatController")]
	[PLRequiresConstantRepaint]
	public class FloatController : PLMonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			switch (ControlMode)
			{
				...
				case ControlModes.OneTime:
					...
					_remappedTimeSinceStart = PLMaths.Remap(GetTime() - _shakeStartTimestamp, 0f, OneTimeDuration, 0f, 1f);
				...
				case ControlModes.ToDestination:
					...
					_remappedTimeSinceStart = PLMaths.Remap(GetTime() - _shakeStartTimestamp, 0f, ToDestinationDuration, 0f, 1f);
