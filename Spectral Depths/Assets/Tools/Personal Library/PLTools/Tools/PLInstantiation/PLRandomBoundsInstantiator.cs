...
namespace SpectralDepths.Tools
{
	...
	public class PLRandomBoundsInstantiator : MonoBehaviour
	{
		...
		[PLEnumCondition("ScaleMode", (int)ScaleModes.Uniform)]
		...
		[PLEnumCondition("ScaleMode", (int)ScaleModes.Vector3)]
		...
		public virtual void InstantiateRandomObject()
		{
			...
			obj.transform.position = PLBoundsExtensions.PLRandomPointInBounds(_collider.bounds);
			...
			switch (ScaleMode)
			{
				...
				case ScaleModes.Vector3:
					_newScale = PLMaths.RandomVector3(MinVectorScale, MaxVectorScale);
