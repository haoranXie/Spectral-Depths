...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Utilities/PLSceneRestarter")]
	public class PLSceneRestarter : MonoBehaviour
	{
		...
		[PLEnumCondition("RestartMode", (int)RestartModes.SpecificScene)]
		...
		{
			Debug.Log("Scene restarted by PLSceneRestarter");
			switch (RestartMode)
			{
