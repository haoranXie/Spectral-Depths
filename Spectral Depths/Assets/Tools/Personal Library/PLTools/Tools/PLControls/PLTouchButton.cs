...
namespace SpectralDepths.Tools
{
	...
	[AddComponentMenu("Spectral Depths/Tools/Controls/PLTouchButton")]
	public class PLTouchButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler, ISubmitHandler
	{
		[Header("Interaction")] 
		...
		[Header("Sprite Swap")]
		[PLInformation("Here you can define, for disabled and pressed states, if you want a different sprite, and a different color.", PLInformationAttribute.InformationType.Info,false)]
		...
		[PLCondition("DisabledChangeColor", true)]
		...
		[PLCondition("PressedChangeColor", true)]
		...
		[PLCondition("HighlightedChangeColor", true)]
		public Color HighlightedColor = Color.white;

		[Header("Opacity")]
		[PLInformation("Here you can set different opacities for the button when it's pressed, idle, or disabled. Useful for visual feedback.",PLInformationAttribute.InformationType.Info,false)]
		...
		[Header("Delays")]
		[PLInformation("Specify here the delays to apply when the button is pressed initially, and when it gets released. Usually you'll keep them at 0.",PLInformationAttribute.InformationType.Info,false)]
		...
		[Header("Animation")]
		[PLInformation("Here you can bind an animator, and specify animation parameter names for the various states.",PLInformationAttribute.InformationType.Info,false)]
		...
		[Header("Mouse Mode")]
		[PLInformation("If you set this to true, you'll need to actually press the button for it to be triggered, otherwise a simple hover will trigger it (better to leave it unchecked if you're going for touch input).", PLInformationAttribute.InformationType.Info,false)]
