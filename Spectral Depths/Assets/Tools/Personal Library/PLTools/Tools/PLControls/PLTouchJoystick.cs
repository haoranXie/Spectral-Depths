...
namespace SpectralDepths.Tools 
{
	...
	[AddComponentMenu("Spectral Depths/Tools/Controls/PLTouchJoystick")]
	public class PLTouchJoystick : PLMonoBehaviour, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
	{
		public enum MaxRangeModes { Distance, DistanceToTransform }
		
		[PLInspectorGroup("Camera", true, 16)]
		...
		[PLInspectorGroup("Joystick Behaviour", true, 18)]
		...
		[PLEnumCondition("MaxRangeMode", (int)MaxRangeModes.Distance)]
		...
		[PLEnumCondition("MaxRangeMode", (int)MaxRangeModes.DistanceToTransform)]
		...
		[PLInspectorGroup("Value Events", true, 19)]
		...
		[PLInspectorGroup("Touch Events", true, 8)]
		...
		[PLInspectorGroup("Rotating Direction Indicator", true, 20)]
		...
		[PLInspectorGroup("Knob Opacity", true, 17)]
		...
		[PLCondition("InterpolateOpacity", true)]
		public float InterpolateOpacitySpeed = 1f;
		
		[PLInspectorGroup("Debug Output", true, 5)]
		...
		public virtual void Initialize()
		{
			...
			{
				throw new Exception("PLTouchJoystick : you have to set a target camera");
			}
		...
		protected virtual void HandleOpacity()
		{
			...
			{
				_canvasGroup.alpha = PLMaths.Lerp(_canvasGroup.alpha, _targetOpacity, InterpolateOpacitySpeed, Time.unscaledDeltaTime);	
			}
			else
			{
