...
{	
	/// <summary>
	/// This persistent singleton handles the inputs and sends commands to the player in the PLControls demo, its sole purpose is to output debug logs of the various interactions with the demo's inputs
	/// </summary>
	public class PLControlsTestInputManager : MonoBehaviour, PLEventListener<PLSwipeEvent>
	{
		...
		public virtual void LeftJoystickMovement(Vector2 movement) { PLDebug.DebugOnScreen("left joystick",movement); }
		public virtual void RightJoystickMovement(Vector2 movement) { PLDebug.DebugOnScreen("right joystick", movement); }
		public virtual void RepositionableJoystickMovement(Vector2 movement) { PLDebug.DebugOnScreen("Repositionable joystick", movement); }
		public virtual void FollowerJoystickMovement(Vector2 movement) { PLDebug.DebugOnScreen("Follower joystick", movement); }

		public virtual void APressed() { PLDebug.DebugOnScreen("Button A Pressed"); }
		public virtual void BPressed() { PLDebug.DebugOnScreen("Button B Pressed"); }
		public virtual void XPressed() { PLDebug.DebugOnScreen("Button X Pressed"); }
		public virtual void YPressed() { PLDebug.DebugOnScreen("Button Y Pressed"); }
		public virtual void RTPressed()	{ PLDebug.DebugOnScreen("Button RT Pressed"); }
		...
		public virtual void HorizontalAxisPressed(float value) { PLDebug.DebugOnScreen("horizontal movement",value); }
		public virtual void VerticalAxisPressed(float value) { PLDebug.DebugOnScreen("vertical movement",value); }
		...
		public virtual void OnMMEvent(PLSwipeEvent swipeEvent)
		{
		...
		{
			this.PLEventStartListening<PLSwipeEvent>();
		}

		protected virtual void OnDisable()
		{
			this.PLEventStopListening<PLSwipeEvent>();
		}
	}
}