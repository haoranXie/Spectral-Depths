...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Activation/PLApplicationPlatformActivation")]
	public class PLApplicationPlatformActivation : MonoBehaviour
	{
		...
		protected virtual void DisableIfNeeded(PlatformBindings.PlatformActions platform, string platformName)
		{
			if (this.gameObject.activeInHierarchy && (platform == PlatformBindings.PlatformActions.Disable))
			{
				...
				{
					Debug.LogFormat(this.gameObject.name + " got disabled via PLPlatformActivation, platform : " + platformName + ".");
				}
			}
		}
	}
