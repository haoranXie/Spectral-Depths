...
{
	[AddComponentMenu("Spectral Depths/Tools/Activation/PLTriggerAndCollision")]
	public class PLTriggerAndCollision : MonoBehaviour 
	{
		...
		{
			if (Collision2DLayerMask.PLContains (collision.gameObject))
			{
		...
		{
			if (Trigger2DLayerMask.PLContains (collider.gameObject))
			{
		...
		{
			if (TriggerLayerMask.PLContains (collider.gameObject))
			{
