...
{
	/// <summary>
	/// A class used to store PLInputExecution bindings, associating a target keycode to UnityEvents
	/// </summary>
	[System.Serializable]
	public class PLInputExecutionBinding
	{
		#if ENABLE_INPUT_SYSTEM && !ENABLE_LEGACY_INPUT_MANAGER
	...
	/// </summary>
	public class PLInputExecution : MonoBehaviour
	{
		[Header("Bindings")]
		/// a list of bindings
		public List<PLInputExecutionBinding> Bindings;
		...
		protected virtual void HandleInput()
		{
			...
			foreach(PLInputExecutionBinding binding in Bindings)
			{
