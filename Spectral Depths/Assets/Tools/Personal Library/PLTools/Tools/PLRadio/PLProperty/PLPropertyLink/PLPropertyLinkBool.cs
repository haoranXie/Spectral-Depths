...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLPropertyLinkBool : PLPropertyLink
	{
		...
		/// <param name="property"></param>
		/// <returns></returns>
		protected virtual bool GetValueOptimized(PLProperty property)
		{
		...
		protected virtual void SetValueOptimized(PLProperty property, bool newValue)
		{
