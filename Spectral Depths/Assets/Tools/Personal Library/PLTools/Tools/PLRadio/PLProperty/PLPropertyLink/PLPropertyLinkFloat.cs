...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLPropertyLinkFloat : PLPropertyLink
	{
		...
		public override void SetLevel(PLPropertyReceiver receiver, PLProperty property, float level)
		{
			...
			_newValue = PLMaths.Remap(level, 0f, 1f, receiver.FloatRemapZero, receiver.FloatRemapOne);
		...
		/// <param name="property"></param>
		/// <returns></returns>
		protected virtual float GetValueOptimized(PLProperty property)
		{
		...
		protected virtual void SetValueOptimized(PLProperty property, float newValue)
		{
