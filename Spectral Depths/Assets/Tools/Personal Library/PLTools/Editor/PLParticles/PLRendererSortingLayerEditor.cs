...
namespace SpectralDepths.Tools
{
	...
	[CustomEditor(typeof(PLRendererSortingLayer), true)]
	public class PLRendererLayerEditor : Editor
	{
		int popupMenuIndex;
		string[] sortingLayerNames;
		protected PLRendererSortingLayer _mmRendererSortingLayer;
		protected Renderer _renderer;

		void OnEnable()
		{
			sortingLayerNames = GetSortingLayerNames(); 
			_mmRendererSortingLayer = (PLRendererSortingLayer)target;
