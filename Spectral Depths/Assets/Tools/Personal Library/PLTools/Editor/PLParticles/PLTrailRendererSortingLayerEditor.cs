...
namespace SpectralDepths.Tools
{
	...
	[CustomEditor(typeof(PLTrailRendererSortingLayer), true)]
	public class PLTrailRendererLayerEditor : Editor
	{
		int popupMenuIndex;
		string[] sortingLayerNames;
		protected PLTrailRendererSortingLayer _mmTrailRendererSortingLayer;
		protected TrailRenderer _trailRenderer;

		void OnEnable()
		{
			sortingLayerNames = GetSortingLayerNames(); 
			_mmTrailRendererSortingLayer = (PLTrailRendererSortingLayer)target;
