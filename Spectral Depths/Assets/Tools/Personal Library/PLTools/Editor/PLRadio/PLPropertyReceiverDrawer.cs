...
{
	[CustomPropertyDrawer(typeof(PLPropertyReceiver), true)]
	[CanEditMultipleObjects]
	public class PLPropertyReceiverDrawer : PLPropertyPickerDrawer
	{
		protected Color _mmYellow = new Color(1f, 0.7686275f, 0f);
		protected Color _mmRed = PLColors.Orangered;
