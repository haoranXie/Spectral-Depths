...
{
	[CustomPropertyDrawer(typeof(PLTweenType))]
	public class PLTweenTypeDrawer : PropertyDrawer
	{
		...
		{
			var type = property.FindPropertyRelative("PLTweenDefinitionType");
			...
			EditorGUI.PropertyField(definitionTypeRect, property.FindPropertyRelative("PLTweenDefinitionType"), GUIContent.none);
			if (type.enumValueIndex == 0)
			{
				EditorGUI.PropertyField(curveRect, property.FindPropertyRelative("PLTweenCurve"), GUIContent.none);
			}
