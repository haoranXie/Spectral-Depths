...
namespace SpectralDepths.Tools
{
	...
	[CustomPropertyDrawer(typeof(PLConditionAttribute))]
	public class PLConditionAttributeDrawer : PropertyDrawer
	{
		#if  UNITY_EDITOR
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			PLConditionAttribute conditionAttribute = (PLConditionAttribute)attribute;
		...
		private bool GetConditionAttributeResult(PLConditionAttribute conditionAttribute, SerializedProperty property)
		{
			bool enabled = true;
		...
		private bool ShouldDisplay(PLConditionAttribute conditionAttribute, bool result)
		{
