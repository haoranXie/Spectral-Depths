...
{	
	[CustomPropertyDrawer (typeof(PLInformationAttribute))]
	/// <summary>
	/// This class allows the display of a message box (warning, info, error...) next to a property (before or after)
	/// </summary>
	public class PLInformationAttributeDrawer : PropertyDrawer 
	{
		...
		PLInformationAttribute informationAttribute { get { return ((PLInformationAttribute)attribute); } }
