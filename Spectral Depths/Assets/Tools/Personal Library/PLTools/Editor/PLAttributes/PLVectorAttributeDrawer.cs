...
{
	[CustomPropertyDrawer(typeof(PLVectorAttribute))]
	public class PLVectorLabelsAttributeDrawer : PropertyDrawer
	{
		...
		{
			PLVectorAttribute vector = (PLVectorAttribute)attribute;
		...
		protected T[] DrawFields<T>(Rect rect, T[] vector, string mainLabel, System.Func<Rect, GUIContent, T, T> fieldDrawer, PLVectorAttribute vectors, GUIContent originalGuiContent)
		{
			T[] result = vector;
