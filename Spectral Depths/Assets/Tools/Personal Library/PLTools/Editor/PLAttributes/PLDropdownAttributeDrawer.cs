...
{
	[CustomPropertyDrawer(typeof(PLDropdownAttribute))]
	public class PLDropdownAttributeDrawer : PropertyDrawer
	{        
		protected PLDropdownAttribute _dropdownAttribute;
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			{
				_dropdownAttribute = (PLDropdownAttribute)attribute;
