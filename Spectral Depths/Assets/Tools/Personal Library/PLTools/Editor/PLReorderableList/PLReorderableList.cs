...
{
	public class PLReorderableList {
		...
		public delegate void ActionDelegate(PLReorderableList list);
		public delegate bool ActionBoolDelegate(PLReorderableList list);
		public delegate void AddDropdownDelegate(Rect buttonRect, PLReorderableList list);
		public delegate Object DragDropReferenceDelegate(Object[] references, PLReorderableList list);
		public delegate void DragDropAppendDelegate(Object reference, PLReorderableList list);
		public delegate float GetElementHeightDelegate(SerializedProperty element);
		public delegate float GetElementsHeightDelegate(PLReorderableList list);
		...
		public PLReorderableList(SerializedProperty list)
			: this(list, true, true, true) {
		}

		public PLReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable)
			: this(list, canAdd, canRemove, draggable, ElementDisplayType.Auto, null, null, null) {
		}

		public PLReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, Texture elementIcon) 
			: this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon) {
		}

		public PLReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, Texture elementIcon) {
