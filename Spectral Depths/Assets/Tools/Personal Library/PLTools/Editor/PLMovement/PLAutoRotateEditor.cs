...
{
	/// <summary>
	/// Custom editor for the PLAutoRotate component
	/// </summary>
	[CustomEditor(typeof(PLAutoRotate), true)]
	[CanEditMultipleObjects]
	public class PLAutoRotateEditor : Editor
	{
		/// <summary>
		/// 
		/// </summary>
		...
		static void DrawHandles(PLAutoRotate autoRotate, GizmoType gizmoType)
		{
			PLAutoRotate myTarget = autoRotate;
			...
			PLDebug.DebugDrawArrow(origin, direction, myTarget.OrbitLineColor);
		}
	}
}