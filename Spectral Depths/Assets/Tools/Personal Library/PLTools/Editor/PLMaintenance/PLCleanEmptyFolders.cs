...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLCleanEmptyFolders : MonoBehaviour
	{
		...
		/// </summary>
		[MenuItem("Tools/Spectral Depths/Cleanup empty folders", false, 504)]
		protected static void CleanupMissingScripts()
		{
			...
			{
				_consoleLog = "[PLCleanEmptyFolders] Removed "+ _listOfEmptyDirectories.Count + " empty directories:\n";
