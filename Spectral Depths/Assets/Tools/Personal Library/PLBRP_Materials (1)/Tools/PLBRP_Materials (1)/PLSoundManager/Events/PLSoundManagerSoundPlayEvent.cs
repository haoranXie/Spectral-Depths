...
{
	/// <summary>
	/// This event will let you play a sound on the PLSoundManager
	///
	/// Example : PLSoundManagerSoundPlayEvent.Trigger(ExplosionSfx, PLSoundManager.PLSoundManagerTracks.Sfx, this.transform.position);
	/// will play a clip (here ours is called ExplosionSfx) on the SFX track, at the position of the object calling it
	/// </summary>
	public struct PLSoundManagerSoundPlayEvent
	{
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		
		public delegate AudioSource Delegate(AudioClip clip, PLSoundManagerPlayOptions options); 
		...
		static public AudioSource Trigger(AudioClip clip, PLSoundManagerPlayOptions options)
		{
			return OnEvent?.Invoke(clip, options);
		}

		static public AudioSource Trigger(AudioClip audioClip, PLSoundManager.PLSoundManagerTracks mmSoundManagerTrack, Vector3 location, 
