...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/VFX/PanningTexture")]
	public class PLPanningTexture : MonoBehaviour
	{
		[PLInformation("This script will let you pan a texture on an attached Renderer.",SpectralDepths.Tools.PLInformationAttribute.InformationType.Info,false)]
