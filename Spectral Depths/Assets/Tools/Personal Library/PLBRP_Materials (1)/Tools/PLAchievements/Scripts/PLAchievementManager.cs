...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public static class PLAchievementManager
	{
		public static List<PLAchievement> AchievementsList { get { return _achievements; }}

		private static List<PLAchievement> _achievements;
		private static PLAchievement _achievement = null;

		public static string _defaultFileName = "Achievements";
		public static string _saveFolderName = "PLAchievements/";
		...
		/// </summary>
		public static void LoadAchievementList(PLAchievementList achievementList)
		{
			_achievements = new List<PLAchievement> ();
			...
			foreach (PLAchievement achievement in achievementList.Achievements)
			{
		...
		private static PLAchievement AchievementManagerContains(string searchedID)
		{
			if (_achievements.Count == 0)
			{
				return null;
			}
			foreach(PLAchievement achievement in _achievements)
			{
		...
		public static void ResetAchievements(string listID)
		{
			...
			PLSaveLoadManager.DeleteSave(SaveFileName + _saveFileExtension, _saveFolderName);
		...
		{
			DeterminePath ();
			SerializedMMAchievementManager serializedMMAchievementManager = (SerializedMMAchievementManager)PLSaveLoadManager.Load(typeof(SerializedMMAchievementManager), SaveFileName+ _saveFileExtension, _saveFolderName);
		...
		public static void SaveAchievements()
		{
			...
			PLSaveLoadManager.Save(serializedMMAchievementManager, SaveFileName+_saveFileExtension, _saveFolderName);
		}
