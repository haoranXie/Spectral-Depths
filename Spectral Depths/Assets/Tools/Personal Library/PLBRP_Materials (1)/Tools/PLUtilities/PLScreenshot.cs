...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Utilities/PLScreenshot")]
	public class PLScreenshot : MonoBehaviour
	{
		...
		[PLEnumCondition("Method", (int)Methods.ScreenCapture)]        
		public int GameViewSizeMultiplier = 3;

		/// the camera to use to take the screenshot with
		[PLEnumCondition("Method", (int)Methods.RenderTexture)]        
		...
		[PLInspectorButton("TakeScreenshot")]
		...
		protected virtual void TakeScreenshot()
		{
			...
			Debug.Log("[PLScreenshot] Screenshot taken and saved at " + savePath);
		}
		...
		{
			string savePath = FolderName + "/screenshot_" + ResolutionWidth + "x" + ResolutionHeight + "_" + System.DateTime.Now.ToString("yyyy-PL-dd_HH-mm-ss") + ".png";
