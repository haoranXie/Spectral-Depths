...
namespace SpectralDepths.Tools
{
	...
	[ExecuteAlways]
	#endif
	public class PLTransformRandomizer : MonoBehaviour
	{
		...
		[PLCondition("RandomizePosition", true)]
		...
		[PLCondition("RandomizeRotation", true)]
		...
		[PLCondition("RandomizeScale", true)]
		...
		protected virtual void ProcessRandomizePosition()
		{
			...
			Vector3 randomPosition = PLMaths.RandomVector3(MinRandomPosition, MaxRandomPosition);
		...
		protected virtual void ProcessRandomizeRotation()
		{
			...
			Vector3 randomRotation = PLMaths.RandomVector3(MinRandomRotation, MaxRandomRotation);
		...
		protected virtual void ProcessRandomizeScale()
		{
			...
			Vector3 randomScale = PLMaths.RandomVector3(MinRandomScale, MaxRandomScale);
