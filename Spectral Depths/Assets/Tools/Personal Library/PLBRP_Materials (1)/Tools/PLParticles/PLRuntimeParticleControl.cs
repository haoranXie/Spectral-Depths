...
namespace SpectralDepths.Tools
{
	...
	public class PLRuntimeParticleControl : MonoBehaviour
	{
		/// <summary>
		...
		[PLInspectorButton("Play")] public bool PlayButton;
		/// a test button to pause the associated particle system
		[PLInspectorButton("Pause")] public bool PauseButton;
		/// a test button to stop the associated particle system
		[PLInspectorButton("Stop")] public bool StopButton;
		...
		[PLInspectorButton("Simulate")] public bool FastForwardToTimeButton;
		...
		[PLEnumCondition("TrackerMode", (int)TrackerModes.ForcedBounds)]
		...
		protected void OnValidate()
		{
			...
			Timestamp = PLMaths.Remap(Tracker, 0f, 1f, minBound, maxBound);
