...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLAnimatorMirror : MonoBehaviour
	{
		/// a struct used to store bindings
		public struct PLAnimatorMirrorBind
		{
		...
		protected List<PLAnimatorMirrorBind> _updateParameters;
		...
		public virtual void Initialization()
		{
			...
			_updateParameters = new List<PLAnimatorMirrorBind>();
			...
			foreach (AnimatorControllerParameter sourceParam in _sourceParameters)
			{
				foreach (AnimatorControllerParameter targetParam in _targetParameters)
				{
					...
					{
						PLAnimatorMirrorBind bind = new PLAnimatorMirrorBind();
		...
		protected virtual void Mirror()
		{
			...
			foreach (PLAnimatorMirrorBind bind in _updateParameters)
			{
