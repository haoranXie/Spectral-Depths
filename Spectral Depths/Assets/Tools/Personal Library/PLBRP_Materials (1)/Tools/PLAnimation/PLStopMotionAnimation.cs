...
{
	[AddComponentMenu("Spectral Depths/Tools/Animation/PLStopMotionAnimation")]
	public class PLStopMotionAnimation : MonoBehaviour
	{
		...
		[PLEnumCondition("FramerateMode", (int)FramerateModes.Automatic)]
		public float FramesPerSecond = 4f;
		[PLEnumCondition("FramerateMode", (int)FramerateModes.Automatic)]
		public float PollFrequency = 1f;

		[PLEnumCondition("FramerateMode", (int)FramerateModes.Manual)]
