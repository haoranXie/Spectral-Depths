...
namespace SpectralDepths.Tools
{
	...
	/// <summary>
	/// The possible methods to save and load files to and from disk available in the PLSaveLoadManager
	/// </summary>
	public enum PLSaveLoadManagerMethods { Json, JsonEncrypted, Binary, BinaryEncrypted };

	/// <summary>
	/// This class implements methods to encrypt and decrypt streams
	/// </summary>
	public abstract class PLSaveLoadManagerEncrypter
	{
		/// <summary>
