...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLSaveLoadManagerMethodBinaryEncrypted : PLSaveLoadManagerEncrypter, IMMSaveLoadManagerMethod
	{
		/// <summary>
		...
		public object Load(System.Type objectType, FileStream saveFile)
		{
			...
			{
				Debug.LogError("[PLSaveLoadManager] Encryption key error: " + ce.Message);
				return null;
			}
			memoryStream.Position = 0;
