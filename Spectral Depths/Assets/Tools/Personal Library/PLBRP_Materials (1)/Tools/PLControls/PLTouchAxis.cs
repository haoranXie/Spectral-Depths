...
{	
	...
	[AddComponentMenu("Spectral Depths/Tools/Controls/PLTouchAxis")]
	public class PLTouchAxis : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler
	{
		...
		[PLInformation("Here you can set the opacity of the button when it's pressed. Useful for visual feedback.",PLInformationAttribute.InformationType.Info,false)]
		...
		[Header("Mouse Mode")]
		[PLInformation("If you set this to true, you'll need to actually press the axis for it to be triggered, otherwise a simple hover will trigger it (better for touch input).", PLInformationAttribute.InformationType.Info,false)]
