...
namespace SpectralDepths.Tools
{
	...
	public static class GameObjectExtensions
	{
		...
		/// <returns></returns>
		public static Component PLGetComponentNoAlloc(this GameObject @this, System.Type componentType)
		{
		...
		/// <param name="this"></param>
		/// <returns></returns>
		public static T PLGetComponentNoAlloc<T>(this GameObject @this) where T : Component
		{
		...
		/// <typeparam name="T"></typeparam>
		/// <returns></returns>
		public static T PLGetComponentAroundOrAdd<T>(this GameObject @this) where T : Component
		{
