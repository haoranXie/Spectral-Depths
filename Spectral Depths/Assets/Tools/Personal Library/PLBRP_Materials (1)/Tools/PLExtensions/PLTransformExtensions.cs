...
namespace SpectralDepths.Tools
{
	...
	public static class TransformExtensions
	{
		...
		public static void PLDestroyAllChildren(this Transform transform)
		{
		...
		/// <returns></returns>
		public static Transform PLFindDeepChildBreadthFirst(this Transform parent, string transformName)
		{
		...
		/// <param name="transformName"></param>
		/// <returns></returns>
		public static Transform PLFindDeepChildDepthFirst(this Transform parent, string transformName)
		{
			foreach (Transform child in parent)
			{
				...
				Transform result = child.PLFindDeepChildDepthFirst(transformName);
				if (result != null)
				{
					return result;
				}
