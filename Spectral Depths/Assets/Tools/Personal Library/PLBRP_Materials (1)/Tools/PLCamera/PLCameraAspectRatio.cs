...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Tools/Camera/PLCameraAspectRatio")]
	public class PLCameraAspectRatio : MonoBehaviour 
	{
		...
		[PLEnumCondition("Mode", (int)Modes.Fixed)]
		...
		[Header("Debug")] 
		[PLInspectorButton("ApplyAspectRatio")]
