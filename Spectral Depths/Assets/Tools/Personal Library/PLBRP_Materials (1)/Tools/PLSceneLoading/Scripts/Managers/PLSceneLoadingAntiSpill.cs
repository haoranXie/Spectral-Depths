...
{
	/// <summary>
	/// This helper class, meant to be used by the PLAdditiveSceneLoadingManager, creates a temporary scene to store objects that might get instantiated, and empties it in the destination scene once loading is complete
	/// </summary>
	public class PLSceneLoadingAntiSpill
	{
		...
		public virtual void PrepareAntiFill(string sceneToLoadName, string antiSpillSceneName = "")
		{
			...
			else
			{
				...
				{
					Debug.LogError("PLSceneLoadingAntiSpill : impossible to load the '"+antiSpillSceneName+"' scene, " +
