...
namespace SpectralDepths.Tools
{
	...
	/// </summary>
	public class PLFindPrefabsByMono : EditorWindow
	{
		...
		/// Menu bound method
		/// </summary>
		[MenuItem("Tools/Spectral Depths/Prefab Finder", false, 504)]
		...
		public static void OpenWindow()
		{
			...
			PLFindPrefabsByMono window = (PLFindPrefabsByMono)EditorWindow.GetWindow(typeof(PLFindPrefabsByMono));
			window.position = new Rect(400, 400, 800, 600);
			window.titleContent = new GUIContent("PL Prefabs Finder");
			window.Show();
		}
