...
{
	/// <summary>
	/// Custom editor for the PLScreenSafeZones component
	/// </summary>
	[CustomEditor(typeof(PLAspectRatioSafeZones), true)]
	[CanEditMultipleObjects]
	public class PLAspectRatioSafeZonesEditor : Editor
	{
		static PLAspectRatioSafeZones safeZones;
		...
		void OnEnable()
		{
			...
			safeZones = (PLAspectRatioSafeZones)target;
			SceneView.duringSceneGui += OnSceneGUI;            
		}
