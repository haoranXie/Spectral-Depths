...
{	
	...
	/// </summary>
	public class PLSpriteReplace : MonoBehaviour 
	{

		[Header("Sprites")]
		[PLInformation("Add this to an Image or a SpriteRenderer to be able to swap between two sprites.", SpectralDepths.Tools.PLInformationAttribute.InformationType.Info, false)]
		...
		[Header("Debug")]
		[PLInspectorButton("Swap")]
		public bool SwapButton;
		[PLInspectorButton("SwitchToOffSprite")]
		public bool SwitchToOffSpriteButton;
		[PLInspectorButton("SwitchToOnSprite")]
		...
		protected PLTouchButton _mmTouchButton;
		...
		protected virtual void Initialization()
		{
			...
			// grabs button
			_mmTouchButton = GetComponent<PLTouchButton> ();
