...
namespace ProPixelizer
{
    ...
    public class ProPixelizerVerification
    {
        ...
        {
#if UNITY_EDITOR
            AssetDatabase.ImportAsset("Assets/Tools/Pixelizer/ShaderGraph/ProPixelizerBase.shadergraph", ImportAssetOptions.ForceUpdate);
            AssetDatabase.ImportAsset("Assets/Tools/Pixelizer/SRP/PixelizedWithOutline.shader", ImportAssetOptions.ForceUpdate);
#endif
        }
