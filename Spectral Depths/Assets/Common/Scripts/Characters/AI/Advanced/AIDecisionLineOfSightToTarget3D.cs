...
namespace SpectralDepths.TopDown
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Character/AI/Decisions/AIDecisionLineOfSightToTarget3D")]
	public class AIDecisionLineOfSightToTarget3D : AIDecision
	{
		...
		protected virtual bool CheckLineOfSight()
		{
			...
			RaycastHit hit = PLDebug.Raycast3D(_raycastOrigin, _directionToTarget.normalized, _directionToTarget.magnitude, ObstacleLayerMask, Color.yellow, true);
