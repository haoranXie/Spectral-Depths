...
namespace SpectralDepths.TopDown
{
	...
	/// </summary>
	[AddComponentMenu("Spectral Depths/Character/AI/Decisions/AIDecisionReloadNeeded")]
	public class AIDecisionReloading : AIDecision
	{
		...
		public override bool Decide()
		{
			...
			return _characterHandleWeapon.CurrentWeapon._reloading;
		}
	}
}