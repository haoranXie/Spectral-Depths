...
namespace SpectralDepths.InventoryEngine
{
	...
	public class InventoryItem : ScriptableObject 
	{
		...
		[PLCondition("ForceSlotIndex", true)]
		...
		[PLCondition("ForcePrefabDropQuantity", true)]
		...
		public PLSpawnAroundProperties DropProperties;
			...
			if (TargetInventoryWithoutName(CharacterID) != null)
			{
				...
				if (Prefab!=null && TargetInventoryWithoutName(CharacterID).TargetTransform!=null)
				{
					...
					if (droppedObject.GetComponentInChildren<ItemPicker>()!=null)
					{
						...
						{
							droppedObject.GetComponentInChildren<ItemPicker>().Quantity = PrefabDropQuantity;
							droppedObject.GetComponentInChildren<ItemPicker>().RemainingQuantity = PrefabDropQuantity;	
						}
						newPosition += droppedObject.GetComponentInChildren<ItemPicker>().PositionOffset;
					}
