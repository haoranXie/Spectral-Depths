...
{	
	...
	public class InventoryHotbar : InventoryDisplay 
	{
		...
		[PLInformation("Here you can define the keys your hotbar will listen to to activate the hotbar's action.",PLInformationAttribute.InformationType.Info,false)]
		#if ENABLE_INPUT_SYSTEM && !ENABLE_LEGACY_INPUT_MANAGER
