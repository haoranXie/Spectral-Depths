...
{	
	...
	/// </summary>
	public class InventoryDemoCharacter : MonoBehaviour, PLEventListener<PLInventoryEvent>
	{
		[PLInformation(
		...
		/// <summary>
		/// Catches PLInventoryEvents and if it's an "inventory loaded" one, equips the first armor and weapon stored in the corresponding inventories
		/// </summary>
		...
		/// <summary>
		/// On Enable, we start listening to PLInventoryEvents
		/// </summary>
		...
		/// <summary>
		/// On Disable, we stop listening to PLInventoryEvents
		/// </summary>
