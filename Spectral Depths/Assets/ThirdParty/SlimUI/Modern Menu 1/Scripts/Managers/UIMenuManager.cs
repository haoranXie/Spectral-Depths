		...
		void SetThemeColors()
		{
			switch (theme)
			{
				case Theme.custom1:
					...
					themeController.currentBackground = themeController.custom1.background1;
				...
				case Theme.custom2:
					...
					themeController.currentBackground = themeController.custom2.background2;
				...
				case Theme.custom3:
					...
					themeController.currentBackground = themeController.custom3.background3;
